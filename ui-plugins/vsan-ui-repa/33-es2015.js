...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SingleSiteFaultDomainsPage", function() { return SingleSiteFaultDomainsPage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TreeItem", function() { return TreeItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DomainTreeItem", function() { return DomainTreeItem; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HostTreeItem", function() { return HostTreeItem; });
...
/* harmony import */ var _component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @component/wizard/flow-metadata */ "ZRZh");
/* harmony import */ var _generated_vsan_fault_domain_spec__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @generated/vsan-fault-domain-spec */ "Pl05");
/* harmony import */ var _util_fault_domains_util__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @util/fault-domains-util */ "JwBD");
...
let SingleSiteFaultDomainsPage = /*@__PURE__*/ (() => {
    let SingleSiteFaultDomainsPage = class SingleSiteFaultDomainsPage {
        constructor() {
            ...
            this.updateFttText = () => {
                const domainAndStandaloneHostsCount = this.domainsAndStandaloneHostsCount;
                const domains = domainAndStandaloneHostsCount[0];
                const standaloneHosts = domainAndStandaloneHostsCount[1];
                this.failuresToTolerate = _util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.configure.faultDomains.faultsToTolerateText", _util_fault_domains_util__WEBPACK_IMPORTED_MODULE_6__["FaultDomainsUtil"].calculateFailuresToTolerate(standaloneHosts, domains, this.availableWitnessHostsCount));
            };
            this.selectItem = (itemName, event) => {
            ...
            this.deleteDomains = () => {
                ...
                let index = this.treeContent.length;
                while (index--) {
                    const item = this.treeContent[index];
            ...
            this.updateDomains = (newDomain) => {
                ...
                while (index--) {
                    ...
                    if (item instanceof DomainTreeItem) {
                        if (item.label !== newDomain.label && item.hosts.length !== 0) {
                            const domainHosts = item.hosts;
                            let hostsIndex = domainHosts.length;
                            while (hostsIndex--) {
                                const domainHost = domainHosts[hostsIndex];
                ...
                let deleteIndex = this.treeContent.length;
                while (deleteIndex--) {
                    const item = this.treeContent[deleteIndex];
            ...
            this.validate = () => {
                ...
                for (const item of this.treeContent) {
                    if (item instanceof DomainTreeItem) {
                        const faultDomain = item.label;
                        this.faultDomainNames.push(faultDomain);
                        for (const host of item.hosts) {
                            this.vsanConfigSpec.faultDomainSpecs.push(_generated_vsan_fault_domain_spec__WEBPACK_IMPORTED_MODULE_5__["VsanFaultDomainSpec"].Factory.create(faultDomain, host.hostRef));
                        }
                    }
                    else if (item instanceof HostTreeItem) {
                        this.vsanConfigSpec.faultDomainSpecs.push(_generated_vsan_fault_domain_spec__WEBPACK_IMPORTED_MODULE_5__["VsanFaultDomainSpec"].Factory.create("", item.hostRef));
                    }
                }
                return null;
            };
             ...
             */
            this.hintDropTarget = (targetItem) => {
                ...
                if (targetItem) {
                    domain = targetItem instanceof DomainTreeItem ?
                        targetItem : this.findDomainByHost(targetItem);
                }
                if (domain != null) {
                    if (domain !== this.findDomainByHost(this.draggedItem)) {
                        this.draggedItem.badgeText = _util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.faultDomains.action.moveHosts.hint.move", domain.label);
                    }
                }
                    ...
                    if (domain) {
                        this.draggedItem.badgeText = _util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.faultDomains.action.moveHosts.hint.remove", domain.label);
                    }
                }
            };
            this.findDomainByHost = (host) => {
                if (!host) {
                    return null;
                }
                const matched = this.treeContent.filter(item => item instanceof DomainTreeItem && item.hosts.indexOf(host) > -1);
                if (matched.length > 0) {
                    return matched[0];
                }
                return null;
            ...
            this.itemDropped = (event, targetItem) => {
                if (!this.draggedItem) {
                    return;
                }
                let domain = null;
                ...
                if (domain != null && domain !== this.findDomainByHost(this.draggedItem)) {
                    domain.hosts.push(this.draggedItem);
                }
                else if (domain == null) {
        ...
        ngOnInit() {
            ...
            for (const hostFaultDomainData of this.clusterHostFaultDomainData) {
                ...
                const hostItem = new HostTreeItem(_service_managed_object__WEBPACK_IMPORTED_MODULE_1__["ManagedObject"].fromUid(hostUid), hostFaultDomainData.name, hostFaultDomainData.primaryIconId, domainName, false);
                if (!domainName) {
                    standAloneHosts.push(hostItem);
                }
                else {
                    const domainHosts = domainChildren.hasOwnProperty(domainName) ? domainChildren[domainName] : [];
        ...
        get domainsAndStandaloneHostsCount() {
            let domainsCount = 0;
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_4__["InputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
    ], SingleSiteFaultDomainsPage.prototype, "pageControls", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_4__["InputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)
    ], SingleSiteFaultDomainsPage.prototype, "clusterHostFaultDomainData", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_4__["InputProperty"])(),
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_4__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
    ], SingleSiteFaultDomainsPage.prototype, "vsanConfigSpec", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_4__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)
    ], SingleSiteFaultDomainsPage.prototype, "faultDomainNames", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_4__["InputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Number)
    ], SingleSiteFaultDomainsPage.prototype, "availableWitnessHostsCount", void 0);
    SingleSiteFaultDomainsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_4__["WizardPage"])(_util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.cluster.configure.wizard.faultDomains.title"), _util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.cluster.configure.wizard.faultDomains.description"))
    ], SingleSiteFaultDomainsPage);
    return SingleSiteFaultDomainsPage;
})();

class TreeItem {
    constructor(label, icon, selected, badgeText = null) {
        this.label = label;
        this.icon = icon;
...
class DomainTreeItem extends TreeItem {
    constructor(label, icon, selected, hosts) {
...
class HostTreeItem extends TreeItem {
    constructor(hostRef, label, icon, domainName, selected) {
        super(label, icon, selected);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClaimDisksWitnessHostPage", function() { return ClaimDisksWitnessHostPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _util_vsan_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @util/vsan-util */ "UODZ");
...
let ClaimDisksWitnessHostPage = /*@__PURE__*/ (() => {
    let ClaimDisksWitnessHostPage = class ClaimDisksWitnessHostPage {
        ngOnInit() {
        ...
        configChange(diskMapping) {
            this.witnessHostDiskMapping = diskMapping;
            this.pageControls.rebuildToc();
        }
        onStoragePoolDisksChange(storagePoolDisks) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
    ], ClaimDisksWitnessHostPage.prototype, "pageControls", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_3__["InputProperty"])(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_3__["InputProperty"].required(false)),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _service_managed_object__WEBPACK_IMPORTED_MODULE_2__["ManagedObject"])
    ], ClaimDisksWitnessHostPage.prototype, "clusterRef", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_3__["InputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _service_managed_object__WEBPACK_IMPORTED_MODULE_2__["ManagedObject"])
    ], ClaimDisksWitnessHostPage.prototype, "witnessHost", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_3__["InputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Boolean)
    ], ClaimDisksWitnessHostPage.prototype, "isVsanMaxWorkflow", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_3__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
    ], ClaimDisksWitnessHostPage.prototype, "witnessHostDiskMapping", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_3__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)
    ], ClaimDisksWitnessHostPage.prototype, "storagePoolDisks", void 0);
    ClaimDisksWitnessHostPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_DeleteDomainWarningComponent", function() { return RenderType_DeleteDomainWarningComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_DeleteDomainWarningComponent_0", function() { return View_DeleteDomainWarningComponent_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_DeleteDomainWarningComponent_Host_0", function() { return View_DeleteDomainWarningComponent_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeleteDomainWarningComponentNgFactory", function() { return DeleteDomainWarningComponentNgFactory; });
/* harmony import */ var _delete_domain_warning_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./delete-domain-warning.scss.shim.ngstyle */ "2tSO");
...
/* harmony import */ var _dialog_prompt_prompt_component_ngfactory__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../dialog/prompt/prompt.component.ngfactory */ "3rpD");
/* harmony import */ var _dialog_prompt_prompt_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../dialog/prompt/prompt.component */ "eCeK");
...
/* harmony import */ var _delete_domain_warning_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./delete-domain-warning.component */ "Zi5c");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes,extraRequire}
...
var RenderType_DeleteDomainWarningComponent = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({ encapsulation: 0, styles: styles_DeleteDomainWarningComponent, data: {} });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_WitnessHostPageComponent", function() { return RenderType_WitnessHostPageComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_WitnessHostPageComponent_0", function() { return View_WitnessHostPageComponent_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_WitnessHostPageComponent_Host_0", function() { return View_WitnessHostPageComponent_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WitnessHostPageComponentNgFactory", function() { return WitnessHostPageComponentNgFactory; });
/* harmony import */ var _witness_host_page_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./witness-host-page.scss.shim.ngstyle */ "TsBT");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _inventory_inventory_browser_component_ngfactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../inventory/inventory-browser.component.ngfactory */ "hrSO");
/* harmony import */ var _inventory_inventory_browser_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../inventory/inventory-browser.component */ "pgRW");
/* harmony import */ var _validation_validation_component_ngfactory__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../validation/validation.component.ngfactory */ "fdDr");
/* harmony import */ var _validation_validation_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../validation/validation.component */ "ie44");
/* harmony import */ var _witness_host_requirements_component_ngfactory__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./witness-host-requirements.component.ngfactory */ "XIz6");
/* harmony import */ var _witness_host_requirements_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./witness-host-requirements.component */ "hAuY");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/common */ "SVse");
/* harmony import */ var _witness_host_page_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./witness-host-page.component */ "qt2f");
/* harmony import */ var _generated_witness_candidate_inventory_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../../generated/witness-candidate-inventory-service */ "96pA");
/* harmony import */ var _service_witness_validation_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../service/witness-validation.service */ "+W3v");
...
/* harmony import */ var _generated_configure_stretched_cluster_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../../generated/configure-stretched-cluster-service */ "3rpZ");
...
var RenderType_WitnessHostPageComponent = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({ encapsulation: 0, styles: styles_WitnessHostPageComponent, data: {} });
...
function View_WitnessHostPageComponent_1(_l) {
    return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 2, "vsan-inventory-browser", [["id", "inventory-browser"]], [[2, "disable-action", null]], [[null, "nodeSelected"]], function (_v, en, $event) {
            ...
            return ad;
        }, _inventory_inventory_browser_component_ngfactory__WEBPACK_IMPORTED_MODULE_2__["View_InventoryBrowserComponent_0"], _inventory_inventory_browser_component_ngfactory__WEBPACK_IMPORTED_MODULE_2__["RenderType_InventoryBrowserComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 49152, null, 0, _inventory_inventory_browser_component__WEBPACK_IMPORTED_MODULE_3__["InventoryBrowserComponent"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]], { searchInputAriaLabelKey: [0, "searchInputAriaLabelKey"], filterContext: [1, "filterContext"], objRefs: [2, "objRefs"], inventoryService: [3, "inventoryService"] }, { nodeSelected: "nodeSelected" }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"]))], function (_ck, _v) { var _co = _v.component; var currVal_1 = "vsan.faultDomains.stretchedCluster.wizard.configure.page.witnessHost.searchInputAriaLabel"; var currVal_2 = _co.filterContext; var currVal_3 = _co.inventoryRoot; var currVal_4 = _co.hostInventoryService; _ck(_v, 1, 0, currVal_1, currVal_2, currVal_3, currVal_4); }, function (_ck, _v) { var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 1).disabled; _ck(_v, 0, 0, currVal_0); });
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HostFilterPipe", function() { return HostFilterPipe; });
class HostFilterPipe {
    /**
     ...
     */
    transform(items, showOnlyStandaloneHosts) {
        return showOnlyStandaloneHosts ? items.filter((item) => !item.domainName) : items;
    }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_SingleSiteFaultDomainsPage", function() { return RenderType_SingleSiteFaultDomainsPage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_SingleSiteFaultDomainsPage_0", function() { return View_SingleSiteFaultDomainsPage_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_SingleSiteFaultDomainsPage_Host_0", function() { return View_SingleSiteFaultDomainsPage_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SingleSiteFaultDomainsPageNgFactory", function() { return SingleSiteFaultDomainsPageNgFactory; });
/* harmony import */ var _single_site_fault_domains_page_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./single-site-fault-domains-page.scss.shim.ngstyle */ "S2lL");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../../node_modules/@clr/angular/clr-angular.ngfactory */ "zl1X");
/* harmony import */ var _clr_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @clr/angular */ "X69f");
/* harmony import */ var _action_button_button_title_directive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../action-button/button-title.directive */ "I0Pd");
/* harmony import */ var _single_site_fault_domain_nodes_component_ngfactory__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./single-site-fault-domain-nodes.component.ngfactory */ "M+L7");
/* harmony import */ var _single_site_fault_domain_nodes_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./single-site-fault-domain-nodes.component */ "VYrB");
/* harmony import */ var ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ng-drag-drop/src/directives/draggable.directive */ "UmOi");
/* harmony import */ var ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ng-drag-drop/src/services/ng-drag-drop.service */ "ZbGM");
/* harmony import */ var ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ng-drag-drop/src/directives/droppable.directive */ "q6c6");
/* harmony import */ var ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _directive_icon_title_icon_title_directive__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../directive/icon-title/icon-title.directive */ "wLY2");
...
/* harmony import */ var _directive_clr_button_group_clr_button_group_common_directive__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../directive/clr-button-group/clr-button-group-common.directive */ "Ju17");
/* harmony import */ var _action_button_button_group_directive__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../action-button/button-group.directive */ "Xbvm");
/* harmony import */ var _create_fault_domain_component_ngfactory__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./create-fault-domain.component.ngfactory */ "ucrt");
/* harmony import */ var _create_fault_domain_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./create-fault-domain.component */ "zNxW");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @angular/forms */ "s7LF");
/* harmony import */ var _single_site_fault_domains_page_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./single-site-fault-domains-page.component */ "5asQ");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes,extraRequire}
...
var RenderType_SingleSiteFaultDomainsPage = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({ encapsulation: 0, styles: styles_SingleSiteFaultDomainsPage, data: {} });
...
function View_SingleSiteFaultDomainsPage_1(_l) {
    return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 6, "clr-button", [["class", "btn btn-sm"], ["id", "deleteDomainAction"], ["name", "deleteDomainAction"]], null, [[null, "click"]], function (_v, en, $event) {
            ...
            return ad;
        }, _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__["View_ClrButton_0"], _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__["RenderType_ClrButton"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](6144, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingListener"], null, [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrButton"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](2, 4243456, [[1, 4], [2, 4], [4, 4]], 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrButton"], [[3, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdv"]], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverToggleService"]], { classNames: [0, "classNames"], name: [1, "name"], id: [2, "id"] }, { _click: "click" }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](3, 212992, [[3, 4]], 0, _action_button_button_title_directive__WEBPACK_IMPORTED_MODULE_4__["ButtonTitleDirective"], [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrButton"]], { title: [0, "title"] }, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵppd"](4, 1), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](5, 0, ["\n      ", "\n   "])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵppd"](6, 1)], function (_ck, _v) { var currVal_0 = "btn btn-sm"; var currVal_1 = "deleteDomainAction"; var currVal_2 = "deleteDomainAction"; _ck(_v, 2, 0, currVal_0, currVal_1, currVal_2); var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 3, 0, _ck(_v, 4, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.removeHost.tooltip")); _ck(_v, 3, 0, currVal_3); }, function (_ck, _v) { var currVal_4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 5, 0, _ck(_v, 6, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.removeHost.label")); _ck(_v, 5, 0, currVal_4); });
}
function View_SingleSiteFaultDomainsPage_3(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "span", [["class", "badge badge-light-blue drop-hint-badge-opacity"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](1, null, ["\n               ", "\n            "]))], null, function (_ck, _v) { var currVal_0 = _v.parent.context.$implicit.badgeText; _ck(_v, 1, 0, currVal_0); }); }
...
function View_SingleSiteFaultDomainsPage_0(_l) {
    return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵpid"](0, _pipe_LocalizationPipe__WEBPACK_IMPORTED_MODULE_12__["LocalizationPipe"], []), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 1, "div", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](3, null, ["", ""])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](5, 0, null, null, 24, "clr-button-group", [["class", "btn-link"], ["vsan-button-group", ""]], [[2, "btn-group", null]], null, null, _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__["View_ClrButtonGroup_0"], _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__["RenderType_ClrButtonGroup"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](135680, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverEventsService"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverEventsService"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverToggleService"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["DOCUMENT"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](4608, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverPositionService"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverPositionService"], [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverEventsService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](512, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdv"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdv"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](512, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverToggleService"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverToggleService"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵo"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵp"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](11, 1097728, null, 1, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrButtonGroup"], [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdv"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrPopoverToggleService"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵo"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrCommonStringsService"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 1, { buttons: 1 }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](13, 1064960, null, 1, _directive_clr_button_group_clr_button_group_common_directive__WEBPACK_IMPORTED_MODULE_13__["ClrButtonGroupCommonDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 2, { clrButtons: 1 }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](15, 16384, null, 2, _action_button_button_group_directive__WEBPACK_IMPORTED_MODULE_14__["ButtonGroupDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], { maximumInlineActions: [0, "maximumInlineActions"] }, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 3, { buttons: 1 }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 4, { clrButtons: 1 }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](19, 0, null, null, 6, "clr-button", [["class", "btn btn-sm"], ["id", "createDomainAction"], ["name", "createDomainAction"]], null, [[null, "click"]], function (_v, en, $event) {
            ...
            return ad;
        }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](32, 212992, null, 0, ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_9__["Droppable"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_8__["NgDragDropService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]], null, { onDrop: "onDrop" }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](34, 0, null, null, 8, "clr-tree", [], [[1, "tabindex", 0], [1, "role", 0], [1, "aria-multiselectable", 0]], [[null, "focusin"]], function (_v, en, $event) {
            var ad = true;
            if (("focusin" === en)) {
            ...
            return ad;
        }, _create_fault_domain_component_ngfactory__WEBPACK_IMPORTED_MODULE_15__["View_CreateFaultDomainComponent_0"], _create_fault_domain_component_ngfactory__WEBPACK_IMPORTED_MODULE_15__["RenderType_CreateFaultDomainComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](46, 49152, null, 0, _create_fault_domain_component__WEBPACK_IMPORTED_MODULE_16__["CreateFaultDomainComponent"], [_angular_forms__WEBPACK_IMPORTED_MODULE_17__["FormBuilder"]], { domainsAndHosts: [0, "domainsAndHosts"], visible: [1, "visible"] }, { visibleChange: "visibleChange", onConfirmation: "onConfirmation" }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"]))], function (_ck, _v) { var _co = _v.component; var currVal_2 = ""; _ck(_v, 15, 0, currVal_2); var currVal_3 = "btn btn-sm"; var currVal_4 = "createDomainAction"; var currVal_5 = "createDomainAction"; _ck(_v, 21, 0, currVal_3, currVal_4, currVal_5); var currVal_6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 22, 0, _ck(_v, 23, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 0), "vsan.faultDomains.action.create.tooltip")); _ck(_v, 22, 0, currVal_6); var currVal_8 = _co.onlyDomainsSelected(); _ck(_v, 28, 0, currVal_8); _ck(_v, 32, 0); var currVal_12 = _co.treeContent; _ck(_v, 41, 0, currVal_12); var currVal_13 = _co.treeContent; var currVal_14 = _co.createDomainDialogVisible; _ck(_v, 46, 0, currVal_13, currVal_14); }, function (_ck, _v) { var _co = _v.component; var currVal_0 = _co.failuresToTolerate; _ck(_v, 3, 0, currVal_0); var currVal_1 = true; _ck(_v, 5, 0, currVal_1); var currVal_7 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 24, 0, _ck(_v, 25, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 0), "vsan.faultDomains.action.create.label")); _ck(_v, 24, 0, currVal_7); var currVal_9 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 37).tabindex; var currVal_10 = "tree"; var currVal_11 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 37).isMultiSelectable; _ck(_v, 34, 0, currVal_9, currVal_10, currVal_11); });
}
function View_SingleSiteFaultDomainsPage_Host_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "ng-component", [], null, null, null, View_SingleSiteFaultDomainsPage_0, RenderType_SingleSiteFaultDomainsPage)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 114688, null, 0, _single_site_fault_domains_page_component__WEBPACK_IMPORTED_MODULE_18__["SingleSiteFaultDomainsPage"], [], null, null)], function (_ck, _v) { _ck(_v, 1, 0); }, null); }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_FaultDomainsPageComponent", function() { return RenderType_FaultDomainsPageComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_FaultDomainsPageComponent_0", function() { return View_FaultDomainsPageComponent_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_FaultDomainsPageComponent_Host_0", function() { return View_FaultDomainsPageComponent_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FaultDomainsPageComponentNgFactory", function() { return FaultDomainsPageComponentNgFactory; });
/* harmony import */ var _fault_domains_page_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fault-domains-page.scss.shim.ngstyle */ "Bh/q");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _fault_domain_nodes_component_ngfactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fault-domain-nodes.component.ngfactory */ "Q2Ow");
/* harmony import */ var _clr_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @clr/angular */ "X69f");
/* harmony import */ var _fault_domain_nodes_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fault-domain-nodes.component */ "bcGm");
...
/* harmony import */ var ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ng-drag-drop/src/directives/draggable.directive */ "UmOi");
/* harmony import */ var ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ng-drag-drop/src/services/ng-drag-drop.service */ "ZbGM");
/* harmony import */ var ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _directive_icon_title_icon_title_directive__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../directive/icon-title/icon-title.directive */ "wLY2");
...
/* harmony import */ var ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ng-drag-drop/src/directives/droppable.directive */ "q6c6");
/* harmony import */ var ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _fault_domains_page_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./fault-domains-page.component */ "mKD/");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes,extraRequire}
...
var RenderType_FaultDomainsPageComponent = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({ encapsulation: 0, styles: styles_FaultDomainsPageComponent, data: {} });
...
function View_FaultDomainsPageComponent_2(_l) {
    return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 16777216, null, null, 4, "vsan-fault-domain-nodes", [], null, [[null, "onSelect"], [null, "onDrop"]], function (_v, en, $event) {
            ...
            return ad;
        }, _fault_domain_nodes_component_ngfactory__WEBPACK_IMPORTED_MODULE_2__["View_FaultDomainNodesComponent_0"], _fault_domain_nodes_component_ngfactory__WEBPACK_IMPORTED_MODULE_2__["RenderType_FaultDomainNodesComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 147456, null, 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ÇlrDatagridDetailRegisterer"], [[2, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵcw"]]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](2, 212992, null, 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrIfExpanded"], [[2, _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"]], { expanded: [0, "expanded"] }, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](3, 49152, null, 0, _fault_domain_nodes_component__WEBPACK_IMPORTED_MODULE_4__["FaultDomainNodesComponent"], [], { domain: [0, "domain"], selectedItem: [1, "selectedItem"], dragScope: [2, "dragScope"] }, { onSelect: "onSelect", onDrop: "onDrop" }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n               "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](0, null, null, 0))], function (_ck, _v) { var _co = _v.component; var currVal_0 = true; _ck(_v, 2, 0, currVal_0); var currVal_1 = _v.parent.context.$implicit; var currVal_2 = _co.selectedPreferredItem; var currVal_3 = "preferred"; _ck(_v, 3, 0, currVal_1, currVal_2, currVal_3); }, null);
}
function View_FaultDomainsPageComponent_1(_l) {
    return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 22, "clr-tree-node", [], [[1, "role", 0], [2, "clr-tree-node", null]], null, null, _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_5__["View_ClrTreeNode_0"], _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_5__["RenderType_ClrTreeNode"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](6144, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingListener"], null, [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵo"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵp"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdq"], [[3, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"]]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](512, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](5, 245760, [[5, 4]], 1, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTreeNode"], [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵo"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"], [3, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTreeNode"]], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrCommonStringsService"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵds"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 6, { treeNodeLinkList: 1 }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, 0, ["\n               "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](8, 0, null, 0, 10, "button", [["class", "clr-treenode-link"], ["draggable", "true"]], [[2, "active", null], [8, "draggable", 0]], [[null, "click"], [null, "dblclick"], [null, "dragstart"], [null, "dragend"], [null, "mousedown"], [null, "touchstart"]], function (_v, en, $event) {
            ...
            if (("dblclick" === en)) {
                var pd_5 = (_co.dropToSecondary({ dragData: _v.context.$implicit }) !== false);
                ad = (pd_5 && ad);
            }
            return ad;
        }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](9, 16384, [[6, 4]], 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTreeNodeLink"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](10, 212992, null, 0, ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_6__["Draggable"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_7__["NgDragDropService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]], { dragData: [0, "dragData"], dragScope: [1, "dragScope"] }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n                  "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](12, 0, null, null, 2, "clr-icon", [], [[1, "shape", 0]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](13, 16384, null, 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrIconCustomTag"], [], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](14, 4210688, null, 0, _directive_icon_title_icon_title_directive__WEBPACK_IMPORTED_MODULE_8__["IconTitleDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n                  "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](16, 0, null, null, 1, "span", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](17, null, ["", ""])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n               "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, 0, ["\n               "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, 2, 1, null, View_FaultDomainsPageComponent_2)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](21, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_9__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]], { ngIf: [0, "ngIf"] }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, 0, ["\n            "]))], function (_ck, _v) { _ck(_v, 5, 0); var currVal_4 = _v.context.$implicit; var currVal_5 = "preferred"; _ck(_v, 10, 0, currVal_4, currVal_5); var currVal_8 = ((_v.context.$implicit == null) ? null : _v.context.$implicit.children); _ck(_v, 21, 0, currVal_8); }, function (_ck, _v) { var _co = _v.component; var currVal_0 = "treeitem"; var currVal_1 = true; _ck(_v, 0, 0, currVal_0, currVal_1); var currVal_2 = (_v.context.$implicit === _co.selectedPreferredItem); var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 10).dragEnabled; _ck(_v, 8, 0, currVal_2, currVal_3); var currVal_6 = _v.context.$implicit.iconId; _ck(_v, 12, 0, currVal_6); var currVal_7 = _v.context.$implicit.label; _ck(_v, 17, 0, currVal_7); });
}
...
function View_FaultDomainsPageComponent_0(_l) {
    return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵpid"](0, _pipe_LocalizationPipe__WEBPACK_IMPORTED_MODULE_10__["LocalizationPipe"], []), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 114, "div", [["class", "configure-fd"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](4, 0, null, null, 45, "div", [["class", "fd-container"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](6, 0, null, null, 28, "div", [["class", "flex-input-wrapper"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](8, 0, null, null, 25, "clr-input-container", [["class", "control-full-width"]], [[2, "clr-form-control", null], [2, "clr-form-control-disabled", null], [2, "clr-row", null]], null, null, _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_5__["View_ClrInputContainer_0"], _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_5__["RenderType_ClrInputContainer"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](512, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbd"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbd"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](131584, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbh"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbh"], [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbd"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](512, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbj"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbj"], [[2, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵb"]]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](12, 1228800, null, 4, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrInputContainer"], [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbh"], [2, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵb"]], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbj"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbd"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 1, { label: 0 }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 2, { controlSuccessComponent: 0 }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 3, { controlErrorComponent: 0 }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 4, { controlHelperComponent: 0 }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](512, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbc"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbc"], []), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n            "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](19, 0, null, 0, 3, "label", [["for", "preferredNameInput"]], [[1, "for", 0]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](20, 212992, [[1, 4]], 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrLabel"], [[2, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbc"]], [2, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵb"]], [2, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵbd"]], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], { forAttr: [0, "forAttr"] }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](21, null, ["\n               ", "\n            "])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵppd"](22, 1), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n            "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](24, 16777216, null, 1, 8, "input", [["class", "fd-name"], ["clrInput", ""], ["id", "preferredNameInput"], ["maxlength", "256"], ["type", "text"]], [[1, "maxlength", 0], [2, "clr-input", null], [8, "id", 0], [2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "ngModelChange"], [null, "input"], [null, "blur"], [null, "compositionstart"], [null, "compositionend"]], function (_v, en, $event) {
            ...
            return ad;
        }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](25, 540672, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["MaxLengthValidator"], [], { maxlength: [0, "maxlength"] }, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NG_VALIDATORS"], function (p0_0) { return [p0_0]; }, [_angular_forms__WEBPACK_IMPORTED_MODULE_11__["MaxLengthValidator"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](27, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["DefaultValueAccessor"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], [2, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["COMPOSITION_BUFFER_MODE"]]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NG_VALUE_ACCESSOR"], function (p0_0) { return [p0_0]; }, [_angular_forms__WEBPACK_IMPORTED_MODULE_11__["DefaultValueAccessor"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](29, 671744, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgModel"], [[8, null], [6, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NG_VALIDATORS"]], [8, null], [6, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NG_VALUE_ACCESSOR"]]], { model: [0, "model"] }, { update: "ngModelChange" }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](2048, null, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgControl"], null, [_angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgModel"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](31, 212992, null, 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrInput"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"], [6, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgControl"]], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], { id: [0, "id"] }, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](32, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgControlStatus"], [[4, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgControl"]]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](36, 0, null, null, 12, "div", [["class", "fd-tree-component"], ["droppable", "true"]], null, [[null, "onDrop"], [null, "drop"]], function (_v, en, $event) {
            var ad = true;
            var _co = _v.component;
            if (("drop" === en)) {
            ...
            return ad;
        }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](37, 212992, null, 0, ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_12__["Droppable"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_7__["NgDragDropService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]], { dropScope: [0, "dropScope"] }, { onDrop: "onDrop" }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](39, 0, null, null, 8, "clr-tree", [], [[1, "tabindex", 0], [1, "role", 0], [1, "aria-multiselectable", 0]], [[null, "focusin"]], function (_v, en, $event) {
            var ad = true;
            if (("focusin" === en)) {
            ...
            return ad;
        }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](91, 540672, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["MaxLengthValidator"], [], { maxlength: [0, "maxlength"] }, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NG_VALIDATORS"], function (p0_0) { return [p0_0]; }, [_angular_forms__WEBPACK_IMPORTED_MODULE_11__["MaxLengthValidator"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](93, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["DefaultValueAccessor"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], [2, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["COMPOSITION_BUFFER_MODE"]]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NG_VALUE_ACCESSOR"], function (p0_0) { return [p0_0]; }, [_angular_forms__WEBPACK_IMPORTED_MODULE_11__["DefaultValueAccessor"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](95, 671744, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgModel"], [[8, null], [6, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NG_VALIDATORS"]], [8, null], [6, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NG_VALUE_ACCESSOR"]]], { model: [0, "model"] }, { update: "ngModelChange" }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](2048, null, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgControl"], null, [_angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgModel"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](97, 212992, null, 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrInput"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"], [6, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgControl"]], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], { id: [0, "id"] }, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](98, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgControlStatus"], [[4, _angular_forms__WEBPACK_IMPORTED_MODULE_11__["NgControl"]]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](102, 0, null, null, 12, "div", [["class", "fd-tree-component"], ["droppable", "true"]], null, [[null, "onDrop"], [null, "drop"]], function (_v, en, $event) {
            var ad = true;
            var _co = _v.component;
            if (("drop" === en)) {
            ...
            return ad;
        }, _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_5__["View_ClrTree_0"], _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_5__["RenderType_ClrTree"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdq"], [[3, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"]]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](512, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵds"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵds"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](108, 1228800, null, 1, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTree"], [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵds"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 11, { rootNodes: 1 }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, 0, ["\n            "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, 0, 1, null, View_FaultDomainsPageComponent_3)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](112, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_9__["NgForOf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["IterableDiffers"]], { ngForOf: [0, "ngForOf"] }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, 0, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"]))], function (_ck, _v) { var _co = _v.component; var currVal_4 = "preferredNameInput"; _ck(_v, 20, 0, currVal_4); var currVal_16 = "256"; _ck(_v, 25, 0, currVal_16); var currVal_17 = _co.preferredName; _ck(_v, 29, 0, currVal_17); var currVal_18 = "preferredNameInput"; _ck(_v, 31, 0, currVal_18); var currVal_19 = "secondary"; _ck(_v, 37, 0, currVal_19); var currVal_23 = _co.preferredDomains; _ck(_v, 46, 0, currVal_23); var currVal_30 = "secondaryNameInput"; _ck(_v, 86, 0, currVal_30); var currVal_42 = "256"; _ck(_v, 91, 0, currVal_42); var currVal_43 = _co.secondaryName; _ck(_v, 95, 0, currVal_43); var currVal_44 = "secondaryNameInput"; _ck(_v, 97, 0, currVal_44); var currVal_45 = "preferred"; _ck(_v, 103, 0, currVal_45); var currVal_49 = _co.secondaryDomains; _ck(_v, 112, 0, currVal_49); }, function (_ck, _v) { var currVal_0 = true; var currVal_1 = ((_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 12).control == null) ? null : _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 12).control.disabled); var currVal_2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 12).addGrid(); _ck(_v, 8, 0, currVal_0, currVal_1, currVal_2); var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 20).forAttr; _ck(_v, 19, 0, currVal_3); var currVal_5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 21, 0, _ck(_v, 22, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 0), "vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.preferredDomain.label")); _ck(_v, 21, 0, currVal_5); var currVal_6 = (_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 25).maxlength ? _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 25).maxlength : null); var currVal_7 = true; var currVal_8 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 31).id; var currVal_9 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 32).ngClassUntouched; var currVal_10 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 32).ngClassTouched; var currVal_11 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 32).ngClassPristine; var currVal_12 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 32).ngClassDirty; var currVal_13 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 32).ngClassValid; var currVal_14 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 32).ngClassInvalid; var currVal_15 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 32).ngClassPending; _ck(_v, 24, 0, currVal_6, currVal_7, currVal_8, currVal_9, currVal_10, currVal_11, currVal_12, currVal_13, currVal_14, currVal_15); var currVal_20 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 42).tabindex; var currVal_21 = "tree"; var currVal_22 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 42).isMultiSelectable; _ck(_v, 39, 0, currVal_20, currVal_21, currVal_22); var currVal_24 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 53, 0, _ck(_v, 54, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 0), "vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.moveToSecondaryDomain.label")); _ck(_v, 53, 0, currVal_24); var currVal_25 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 61, 0, _ck(_v, 62, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 0), "vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.moveToPreferredDomain.label")); _ck(_v, 61, 0, currVal_25); var currVal_26 = true; var currVal_27 = ((_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 78).control == null) ? null : _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 78).control.disabled); var currVal_28 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 78).addGrid(); _ck(_v, 74, 0, currVal_26, currVal_27, currVal_28); var currVal_29 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 86).forAttr; _ck(_v, 85, 0, currVal_29); var currVal_31 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 87, 0, _ck(_v, 88, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 0), "vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.secondaryDomain.label")); _ck(_v, 87, 0, currVal_31); var currVal_32 = (_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 91).maxlength ? _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 91).maxlength : null); var currVal_33 = true; var currVal_34 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 97).id; var currVal_35 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 98).ngClassUntouched; var currVal_36 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 98).ngClassTouched; var currVal_37 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 98).ngClassPristine; var currVal_38 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 98).ngClassDirty; var currVal_39 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 98).ngClassValid; var currVal_40 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 98).ngClassInvalid; var currVal_41 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 98).ngClassPending; _ck(_v, 90, 0, currVal_32, currVal_33, currVal_34, currVal_35, currVal_36, currVal_37, currVal_38, currVal_39, currVal_40, currVal_41); var currVal_46 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 108).tabindex; var currVal_47 = "tree"; var currVal_48 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 108).isMultiSelectable; _ck(_v, 105, 0, currVal_46, currVal_47, currVal_48); });
}
function View_FaultDomainsPageComponent_Host_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "ng-component", [], null, null, null, View_FaultDomainsPageComponent_0, RenderType_FaultDomainsPageComponent)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 114688, null, 0, _fault_domains_page_component__WEBPACK_IMPORTED_MODULE_13__["FaultDomainsPageComponent"], [], null, null)], function (_ck, _v) { _ck(_v, 1, 0); }, null); }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_SingleSiteFaultDomainNodesComponent", function() { return RenderType_SingleSiteFaultDomainNodesComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_SingleSiteFaultDomainNodesComponent_0", function() { return View_SingleSiteFaultDomainNodesComponent_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_SingleSiteFaultDomainNodesComponent_Host_0", function() { return View_SingleSiteFaultDomainNodesComponent_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SingleSiteFaultDomainNodesComponentNgFactory", function() { return SingleSiteFaultDomainNodesComponentNgFactory; });
/* harmony import */ var _single_site_fault_domain_nodes_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./single-site-fault-domain-nodes.scss.shim.ngstyle */ "FL3K");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../../node_modules/@clr/angular/clr-angular.ngfactory */ "zl1X");
/* harmony import */ var _clr_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @clr/angular */ "X69f");
/* harmony import */ var ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-drag-drop/src/directives/draggable.directive */ "UmOi");
/* harmony import */ var ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ng-drag-drop/src/services/ng-drag-drop.service */ "ZbGM");
/* harmony import */ var ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ng-drag-drop/src/directives/droppable.directive */ "q6c6");
/* harmony import */ var ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/common */ "SVse");
/* harmony import */ var _single_site_fault_domain_nodes_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./single-site-fault-domain-nodes.component */ "VYrB");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes,extraRequire}
...
function View_SingleSiteFaultDomainNodesComponent_1(_l) {
    return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 20, "clr-tree-node", [], [[1, "role", 0], [2, "clr-tree-node", null]], null, null, _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__["View_ClrTreeNode_0"], _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__["RenderType_ClrTreeNode"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](6144, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingListener"], null, [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵo"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵp"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdq"], [[3, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"]]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](512, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](5, 245760, null, 1, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTreeNode"], [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵo"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"], [3, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTreeNode"]], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrCommonStringsService"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵds"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 1, { treeNodeLinkList: 1 }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, 0, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](8, 0, null, 0, 11, "button", [["class", "clr-treenode-link"], ["draggable", "true"], ["droppable", "true"]], [[2, "active", null], [8, "draggable", 0]], [[null, "click"], [null, "onDragEnter"], [null, "onDragStart"], [null, "onDrop"], [null, "dragstart"], [null, "dragend"], [null, "mousedown"], [null, "touchstart"], [null, "drop"]], function (_v, en, $event) {
            ...
            if (("click" === en)) {
                var pd_5 = (_co.onSelectItem.emit({ label: _v.context.$implicit.label, event: $event }) !== false);
                ad = (pd_5 && ad);
            }
            if (("onDragEnter" === en)) {
            ...
            if (("onDrop" === en)) {
                var pd_8 = (_co.onDrop.emit({ event: $event, host: _v.context.$implicit }) !== false);
                ad = (pd_8 && ad);
            }
            return ad;
        }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](9, 16384, [[1, 4]], 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTreeNodeLink"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](10, 212992, null, 0, ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_4__["Draggable"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_5__["NgDragDropService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]], { dragData: [0, "dragData"] }, { onDragStart: "onDragStart" }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](11, 212992, null, 0, ng_drag_drop_src_directives_droppable_directive__WEBPACK_IMPORTED_MODULE_6__["Droppable"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_5__["NgDragDropService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]], null, { onDragEnter: "onDragEnter", onDrop: "onDrop" }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](13, 0, null, null, 2, "clr-icon", [], [[1, "shape", 0]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](14, 16384, null, 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrIconCustomTag"], [], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](15, 4210688, null, 0, _directive_icon_title_icon_title_directive__WEBPACK_IMPORTED_MODULE_7__["IconTitleDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](16, null, ["\n      ", "\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, null, 1, null, View_SingleSiteFaultDomainNodesComponent_2)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](18, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_8__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]], { ngIf: [0, "ngIf"] }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, 0, ["\n"]))], function (_ck, _v) { _ck(_v, 5, 0); var currVal_4 = _v.context.$implicit; _ck(_v, 10, 0, currVal_4); _ck(_v, 11, 0); var currVal_7 = _v.context.$implicit.badgeText; _ck(_v, 18, 0, currVal_7); }, function (_ck, _v) { var currVal_0 = "treeitem"; var currVal_1 = true; _ck(_v, 0, 0, currVal_0, currVal_1); var currVal_2 = _v.context.$implicit.selected; var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 10).dragEnabled; _ck(_v, 8, 0, currVal_2, currVal_3); var currVal_5 = _v.context.$implicit.icon; _ck(_v, 13, 0, currVal_5); var currVal_6 = _v.context.$implicit.label; _ck(_v, 16, 0, currVal_6); });
}
function View_SingleSiteFaultDomainNodesComponent_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, null, 1, null, View_SingleSiteFaultDomainNodesComponent_1)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](2, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_8__["NgForOf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["IterableDiffers"]], { ngForOf: [0, "ngForOf"] }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"]))], function (_ck, _v) { var _co = _v.component; var currVal_0 = _co.rootItem.hosts; _ck(_v, 2, 0, currVal_0); }, null); }
function View_SingleSiteFaultDomainNodesComponent_Host_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "vsan-single-site-fault-domain-nodes", [], null, null, null, View_SingleSiteFaultDomainNodesComponent_0, RenderType_SingleSiteFaultDomainNodesComponent)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 49152, null, 0, _single_site_fault_domain_nodes_component__WEBPACK_IMPORTED_MODULE_9__["SingleSiteFaultDomainNodesComponent"], [], null, null)], null, null); }
var SingleSiteFaultDomainNodesComponentNgFactory = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("vsan-single-site-fault-domain-nodes", _single_site_fault_domain_nodes_component__WEBPACK_IMPORTED_MODULE_9__["SingleSiteFaultDomainNodesComponent"], View_SingleSiteFaultDomainNodesComponent_Host_0, { rootItem: "rootItem" }, { onSelectItem: "onSelectItem", onDragEnter: "onDragEnter", onDragStart: "onDragStart", onDrop: "onDrop" }, []);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_FaultDomainNodesComponent", function() { return RenderType_FaultDomainNodesComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_FaultDomainNodesComponent_0", function() { return View_FaultDomainNodesComponent_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_FaultDomainNodesComponent_Host_0", function() { return View_FaultDomainNodesComponent_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FaultDomainNodesComponentNgFactory", function() { return FaultDomainNodesComponentNgFactory; });
/* harmony import */ var _fault_domain_nodes_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fault-domain-nodes.scss.shim.ngstyle */ "zZW2");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../../node_modules/@clr/angular/clr-angular.ngfactory */ "zl1X");
/* harmony import */ var _clr_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @clr/angular */ "X69f");
/* harmony import */ var ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-drag-drop/src/directives/draggable.directive */ "UmOi");
...
/* harmony import */ var _fault_domain_nodes_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./fault-domain-nodes.component */ "bcGm");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes,extraRequire}
...
var RenderType_FaultDomainNodesComponent = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({ encapsulation: 0, styles: styles_FaultDomainNodesComponent, data: {} });
...
function View_FaultDomainNodesComponent_1(_l) {
    return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 19, "clr-tree-node", [], [[1, "role", 0], [2, "clr-tree-node", null]], null, null, _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__["View_ClrTreeNode_0"], _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__["RenderType_ClrTreeNode"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](6144, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["LoadingListener"], null, [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵo"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵp"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](1024, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdq"], [[3, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"]]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](512, null, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](5, 245760, null, 1, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTreeNode"], [_clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵo"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["PLATFORM_ID"], [3, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTreeNode"]], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵdp"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵz"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrCommonStringsService"], _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ɵds"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injector"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵqud"](603979776, 1, { treeNodeLinkList: 1 }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, 0, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](8, 0, null, 0, 10, "button", [["class", "clr-treenode-link"], ["draggable", "true"]], [[2, "active", null], [8, "draggable", 0]], [[null, "click"], [null, "dblclick"], [null, "dragstart"], [null, "dragend"], [null, "mousedown"], [null, "touchstart"]], function (_v, en, $event) {
            ...
            if (("dblclick" === en)) {
                var pd_5 = (_co.onDrop.emit({ dragData: _v.context.$implicit }) !== false);
                ad = (pd_5 && ad);
            }
            return ad;
        }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](9, 16384, [[1, 4]], 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrTreeNodeLink"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](10, 212992, null, 0, ng_drag_drop_src_directives_draggable_directive__WEBPACK_IMPORTED_MODULE_4__["Draggable"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"], ng_drag_drop_src_services_ng_drag_drop_service__WEBPACK_IMPORTED_MODULE_5__["NgDragDropService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]], { dragData: [0, "dragData"], dragScope: [1, "dragScope"] }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](12, 0, null, null, 2, "clr-icon", [], [[1, "shape", 0]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](13, 16384, null, 0, _clr_angular__WEBPACK_IMPORTED_MODULE_3__["ClrIconCustomTag"], [], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](14, 4210688, null, 0, _directive_icon_title_icon_title_directive__WEBPACK_IMPORTED_MODULE_6__["IconTitleDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](16, 0, null, null, 1, "span", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](17, null, ["", ""])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, 0, ["\n"]))], function (_ck, _v) { var _co = _v.component; _ck(_v, 5, 0); var currVal_4 = _v.context.$implicit; var currVal_5 = _co.dragScope; _ck(_v, 10, 0, currVal_4, currVal_5); }, function (_ck, _v) { var _co = _v.component; var currVal_0 = "treeitem"; var currVal_1 = true; _ck(_v, 0, 0, currVal_0, currVal_1); var currVal_2 = ((_co.domain === _co.selectedItem) || (_v.context.$implicit === _co.selectedItem)); var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 10).dragEnabled; _ck(_v, 8, 0, currVal_2, currVal_3); var currVal_6 = _v.context.$implicit.iconId; _ck(_v, 12, 0, currVal_6); var currVal_7 = _v.context.$implicit.label; _ck(_v, 17, 0, currVal_7); });
}
function View_FaultDomainNodesComponent_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, null, 1, null, View_FaultDomainNodesComponent_1)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](2, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_7__["NgForOf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["IterableDiffers"]], { ngForOf: [0, "ngForOf"] }, null)], function (_ck, _v) { var _co = _v.component; var currVal_0 = _co.domain.children; _ck(_v, 2, 0, currVal_0); }, null); }
function View_FaultDomainNodesComponent_Host_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "vsan-fault-domain-nodes", [], null, null, null, View_FaultDomainNodesComponent_0, RenderType_FaultDomainNodesComponent)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 49152, null, 0, _fault_domain_nodes_component__WEBPACK_IMPORTED_MODULE_8__["FaultDomainNodesComponent"], [], null, null)], null, null); }
var FaultDomainNodesComponentNgFactory = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("vsan-fault-domain-nodes", _fault_domain_nodes_component__WEBPACK_IMPORTED_MODULE_8__["FaultDomainNodesComponent"], View_FaultDomainNodesComponent_Host_0, { domain: "domain", selectedItem: "selectedItem", dragScope: "dragScope" }, { onSelect: "onSelect", onDrop: "onDrop" }, []);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WizardSharedPagesModule", function() { return WizardSharedPagesModule; });
class WizardSharedPagesModule {
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SingleSiteFaultDomainNodesComponent", function() { return SingleSiteFaultDomainNodesComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FaultDomainItem", function() { return FaultDomainItem; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _component_wizard_shared_pages_single_site_fault_domains_page_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @component/wizard/shared-pages/single-site-fault-domains-page.component */ "5asQ");
 ...
 */
class SingleSiteFaultDomainNodesComponent {
    constructor() {
...
class FaultDomainItem extends _component_wizard_shared_pages_single_site_fault_domains_page_component__WEBPACK_IMPORTED_MODULE_1__["TreeItem"] {
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_ClaimDisksWitnessHostPage", function() { return RenderType_ClaimDisksWitnessHostPage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_ClaimDisksWitnessHostPage_0", function() { return View_ClaimDisksWitnessHostPage_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_ClaimDisksWitnessHostPage_Host_0", function() { return View_ClaimDisksWitnessHostPage_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ClaimDisksWitnessHostPageNgFactory", function() { return ClaimDisksWitnessHostPageNgFactory; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _diskmgmt_select_disks_component_ngfactory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../diskmgmt/select-disks.component.ngfactory */ "unWr");
/* harmony import */ var _diskmgmt_select_disks_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../diskmgmt/select-disks.component */ "1pCA");
/* harmony import */ var _generated_disk_management_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../generated/disk-management-service */ "a6dL");
/* harmony import */ var _diskmgmt_create_disk_group_component_ngfactory__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../diskmgmt/create-disk-group.component.ngfactory */ "SRn5");
/* harmony import */ var _diskmgmt_create_disk_group_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../diskmgmt/create-disk-group.component */ "uJrr");
/* harmony import */ var _generated_vsan_capability_provider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../generated/vsan-capability-provider */ "y/yc");
/* harmony import */ var _generated_vsan_config_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../generated/vsan-config-service */ "UKIB");
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common */ "SVse");
/* harmony import */ var _claim_disks_witness_host_page_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./claim-disks-witness-host-page.component */ "7sC7");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes,extraRequire}
...
var RenderType_ClaimDisksWitnessHostPage = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵcrt"]({ encapsulation: 2, styles: styles_ClaimDisksWitnessHostPage, data: {} });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_WitnessHostRequirementsComponent", function() { return RenderType_WitnessHostRequirementsComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_WitnessHostRequirementsComponent_0", function() { return View_WitnessHostRequirementsComponent_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_WitnessHostRequirementsComponent_Host_0", function() { return View_WitnessHostRequirementsComponent_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WitnessHostRequirementsComponentNgFactory", function() { return WitnessHostRequirementsComponentNgFactory; });
/* harmony import */ var _witness_host_requirements_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./witness-host-requirements.scss.shim.ngstyle */ "IzOX");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _node_modules_clr_angular_clr_angular_ngfactory__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../../node_modules/@clr/angular/clr-angular.ngfactory */ "zl1X");
/* harmony import */ var _clr_angular__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @clr/angular */ "X69f");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ "SVse");
/* harmony import */ var _pipe_LocalizationPipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../pipe/LocalizationPipe */ "jOVY");
/* harmony import */ var _directive_signpost_title_signpost_title_directive__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../directive/signpost-title/signpost-title.directive */ "0mRq");
/* harmony import */ var _witness_host_requirements_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./witness-host-requirements.component */ "hAuY");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeleteDomainWarningComponent", function() { return DeleteDomainWarningComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _util_vsan_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @util/vsan-util */ "UODZ");
/* Copyright 2017-2020 VMware, Inc. All rights reserved. -- VMware Confidential */


class DeleteDomainWarningComponent {
    constructor() {
        this.domains = [];
    ...
    get dialogTitle() {
        return this.domains.length > 1 ?
            _util_vsan_util__WEBPACK_IMPORTED_MODULE_1__["VsanUiUtils"].getString("vsan.faultDomain.emptyFaultDomainWarning.titleMulti", this.domains.length) :
            _util_vsan_util__WEBPACK_IMPORTED_MODULE_1__["VsanUiUtils"].getString("vsan.faultDomain.emptyFaultDomainWarning.titleSingle");
    }
    get warningDescription() {
        return this.domains.length > 1 ?
            _util_vsan_util__WEBPACK_IMPORTED_MODULE_1__["VsanUiUtils"].getString("vsan.faultDomain.emptyFaultDomainWarning.headerMulti", this.domains.length) :
            _util_vsan_util__WEBPACK_IMPORTED_MODULE_1__["VsanUiUtils"].getString("vsan.faultDomain.emptyFaultDomainWarning.headerSingle");
    }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FaultDomainNodesComponent", function() { return FaultDomainNodesComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* Copyright 2021 VMware, Inc. All rights reserved. -- VMware Confidential */
 ...
 * A separate component is required because of https://github.com/vmware/clarity/issues/5514
 */
class FaultDomainNodesComponent {
    constructor() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WitnessHostRequirementsComponent", function() { return WitnessHostRequirementsComponent; });
class WitnessHostRequirementsComponent {
    constructor() {
        this.headerKey = "";
    }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FaultDomainsPageComponent", function() { return FaultDomainsPageComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
...
/* harmony import */ var _util_vsan_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @util/vsan-util */ "UODZ");
/* harmony import */ var _util_fault_domains_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @util/fault-domains-util */ "JwBD");
var FaultDomainsPageComponent_1;




let FaultDomainsPageComponent = /*@__PURE__*/ (() => {
    let FaultDomainsPageComponent = FaultDomainsPageComponent_1 = class FaultDomainsPageComponent {
        constructor() {
            ...
            this.selectPreferred = (value) => this.selectedPreferredItem = value;
            this.selectSecondary = (value) => this.selectedSecondaryItem = value;
            this.moveToPreferred = () => this.fromSecondaryToPreferred(this.selectedSecondaryItem);
            this.moveToSecondary = () => this.fromPreferredToSecondary(this.selectedPreferredItem);
            this.dropToPreferred = (event) => this.fromSecondaryToPreferred(event.dragData);
            this.dropToSecondary = (event) => this.fromPreferredToSecondary(event.dragData);
        }
        ngOnInit() {
            const preferredDomain = this.availableDomains.find(domain => domain.isPreferred);
            if (preferredDomain) {
            ...
            const actualDomains = this.preferredDomains.filter(i => !i.isHost);
            this.preferredName = actualDomains.length === 1
                ? actualDomains[0].label
                : FaultDomainsPageComponent_1.DEFAULT_PREFERRED_NAME;
            this.secondaryName = FaultDomainsPageComponent_1.DEFAULT_SECONDARY_NAME;
        }
        fromPreferredToSecondary(data) {
         ...
         */
        hasConnectedHosts(domainsAndHosts) {
            const allHosts = [];
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
    ], FaultDomainsPageComponent.prototype, "pageControls", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["InputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)
    ], FaultDomainsPageComponent.prototype, "availableDomains", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["OutputProperty"])(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["OutputProperty"].ifEmpty(_util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.validation.noName"))),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)
    ], FaultDomainsPageComponent.prototype, "preferredName", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["OutputProperty"])(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["OutputProperty"].ifEmpty(_util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.validation.noHosts"))),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)
    ], FaultDomainsPageComponent.prototype, "preferredDomains", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["OutputProperty"])(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["OutputProperty"].ifEmpty(_util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.validation.noName"))),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)
    ], FaultDomainsPageComponent.prototype, "secondaryName", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["OutputProperty"])(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["OutputProperty"].ifEmpty(_util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.validation.noHosts"))),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)
    ], FaultDomainsPageComponent.prototype, "secondaryDomains", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Boolean)
    ], FaultDomainsPageComponent.prototype, "hciWorkflow", void 0);
    FaultDomainsPageComponent = FaultDomainsPageComponent_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_1__["WizardPage"])(_util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.title"), _util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.faultDomains.stretchedCluster.wizard.configure.page.faultDomains.description"))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WitnessHostPageComponent", function() { return WitnessHostPageComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
...
/* harmony import */ var _generated_configure_stretched_cluster_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @generated/configure-stretched-cluster-service */ "3rpZ");
...
/* harmony import */ var _generated_filter_context_key__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @generated/filter-context-key */ "/vq/");
/* harmony import */ var _generated_vsan_stretched_cluster_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @generated/vsan-stretched-cluster-service */ "bxEx");
/* harmony import */ var _generated_witness_candidate_inventory_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @generated/witness-candidate-inventory-service */ "96pA");
/* harmony import */ var _service_managed_object__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @service/managed-object */ "sNBm");
/* harmony import */ var _service_witness_validation_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @service/witness-validation.service */ "+W3v");
/* harmony import */ var _util_disk_mgmt_util__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @util/disk-mgmt.util */ "dSru");
/* harmony import */ var _util_logger__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @util/logger */ "a0OL");
...
let WitnessHostPageComponent = /*@__PURE__*/ (() => {
    let WitnessHostPageComponent = class WitnessHostPageComponent {
        /*
         * Inject hostInventoryService as public as it is needed by the vsan-inventory-browser
         */
        constructor(hostInventoryService, hostValidationService, stretchedClusterService, configureStretchedClusterService, diskManagementService) {
        ...
        hostSelected(event) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                ...
                yield this.queryAndValidateSelectedHost();
            });
        }
        resetValidation() {
        ...
        queryAndValidateSelectedHost() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                this.pageControls.setBusyState();
                [this.hostValidation, this.isWitnessDeployedFromOvf, this.hasDiskGroupsOnWitness] = yield Promise.all([
        ...
        getHostValidationResult() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                try {
                    const hostValidationResult = yield this.configureStretchedClusterService.getNewWitnessHostValidationError(this.clusterRef, this.witnessHost, this.vsanConfigSpec.isVsanMaxEnabled);
                    return this.hostValidationService.handleSingleClusterWitnessValidationResult(hostValidationResult, this.vsanConfigSpec);
                }
                catch (error) {
                    _util_logger__WEBPACK_IMPORTED_MODULE_11__["Logger"].error("Unable to get host validation result: " + error);
                    return this.hostValidationService.handleHostValidationError(error);
                }
            });
        }
        getIsWitnessDeployedFromOvf() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                try {
                    return yield this.stretchedClusterService.isWitnessDeployedFromOvf(this.witnessHost);
                }
                catch (error) {
                    _util_logger__WEBPACK_IMPORTED_MODULE_11__["Logger"].error("Unable to determine if the selected host is a Virtual appliance deployed from an OVF: ", error);
                    return false;
                }
            });
        }
        hasWitnessClaimedDisks() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                try {
                    const witnessDisksData = yield this.diskManagementService
                    ...
                    return this.vsanConfigSpec.isVsanMaxEnabled
                        ? _util_disk_mgmt_util__WEBPACK_IMPORTED_MODULE_10__["DiskMgmtUtil"].hasVsanMaxClaimedDisks(witnessDisksData)
                        : _util_disk_mgmt_util__WEBPACK_IMPORTED_MODULE_10__["DiskMgmtUtil"].hasDiskGroups(witnessDisksData);
                }
                catch (e) {
                    // TODO: dtsvetkova - remove this once 2927115 is resolved
                    _util_logger__WEBPACK_IMPORTED_MODULE_11__["Logger"].error("Unable to get witness host's claimed disks: " + e);
                    return false;
                }
            });
        }
        validate() {
            if (this.hostValidation &&
                [_component_validation_alert_type__WEBPACK_IMPORTED_MODULE_1__["AlertType"].DANGER, _component_validation_alert_type__WEBPACK_IMPORTED_MODULE_1__["AlertType"].WARNING].includes(this.hostValidation.validationAlertType)) {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
    ], WitnessHostPageComponent.prototype, "vsanConfigSpec", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["InputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
    ], WitnessHostPageComponent.prototype, "pageControls", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["InputProperty"])(),
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _service_managed_object__WEBPACK_IMPORTED_MODULE_8__["ManagedObject"])
    ], WitnessHostPageComponent.prototype, "clusterRef", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _service_managed_object__WEBPACK_IMPORTED_MODULE_8__["ManagedObject"])
    ], WitnessHostPageComponent.prototype, "currentWitnessHostRef", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["OutputProperty"])(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["OutputProperty"].ifNull(_util_vsan_util__WEBPACK_IMPORTED_MODULE_12__["VsanUiUtils"].getString("vsan.faultDomains.stretchedCluster.wizard.configure.page.witnessHost.validation.noSelection"))),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _service_managed_object__WEBPACK_IMPORTED_MODULE_8__["ManagedObject"])
    ], WitnessHostPageComponent.prototype, "witnessHost", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)
    ], WitnessHostPageComponent.prototype, "witnessHostName", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Boolean)
    ], WitnessHostPageComponent.prototype, "hasDiskGroupsOnWitness", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)
    ], WitnessHostPageComponent.prototype, "witnessHostDiskMapping", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)
    ], WitnessHostPageComponent.prototype, "storagePoolDisks", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["OutputProperty"])(),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Boolean)
    ], WitnessHostPageComponent.prototype, "isWitnessDeployedFromOvf", void 0);
    WitnessHostPageComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_component_wizard_flow_metadata__WEBPACK_IMPORTED_MODULE_2__["WizardPage"])(_util_vsan_util__WEBPACK_IMPORTED_MODULE_12__["VsanUiUtils"].getString("vsan.faultDomains.stretchedCluster.wizard.configure.page.witnessHost.title"))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_CreateFaultDomainComponent", function() { return RenderType_CreateFaultDomainComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_CreateFaultDomainComponent_0", function() { return View_CreateFaultDomainComponent_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_CreateFaultDomainComponent_Host_0", function() { return View_CreateFaultDomainComponent_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateFaultDomainComponentNgFactory", function() { return CreateFaultDomainComponentNgFactory; });
/* harmony import */ var _create_fault_domain_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create-fault-domain.scss.shim.ngstyle */ "V4jR");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "8Y7J");
...
/* harmony import */ var _dialog_prompt_prompt_component_ngfactory__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../dialog/prompt/prompt.component.ngfactory */ "3rpD");
/* harmony import */ var _dialog_prompt_prompt_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../dialog/prompt/prompt.component */ "eCeK");
...
/* harmony import */ var _util_reference_watcher__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../util/reference-watcher */ "gyvr");
/* harmony import */ var _directive_reactive_forms_autofocus_control_directive__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../directive/reactive-forms/autofocus-control.directive */ "KYLT");
/* harmony import */ var _service_task_monitor_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../service/task-monitor-service */ "81c+");
/* harmony import */ var _delete_domain_warning_component_ngfactory__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./delete-domain-warning.component.ngfactory */ "9JTX");
/* harmony import */ var _delete_domain_warning_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./delete-domain-warning.component */ "Zi5c");
/* harmony import */ var _pipe_LocalizationPipe__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../pipe/LocalizationPipe */ "jOVY");
/* harmony import */ var _create_fault_domain_host_filter_pipe__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./create-fault-domain-host-filter.pipe */ "AX7O");
/* harmony import */ var _create_fault_domain_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./create-fault-domain.component */ "zNxW");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes,extraRequire}
...
function View_CreateFaultDomainComponent_1(_l) {
    return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 165, "div", [["class", "modal"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 162, "div", [["aria-hidden", "true"], ["class", "modal-dialog"], ["role", "dialog"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](4, 0, null, null, 159, "div", [["class", "modal-content"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](6, 0, null, null, 152, "vsan-prompt", [], null, [[null, "alertMessagesChange"], [null, "onCancel"], [null, "onConfirm"]], function (_v, en, $event) {
            ...
            return ad;
        }, _delete_domain_warning_component_ngfactory__WEBPACK_IMPORTED_MODULE_13__["View_DeleteDomainWarningComponent_0"], _delete_domain_warning_component_ngfactory__WEBPACK_IMPORTED_MODULE_13__["RenderType_DeleteDomainWarningComponent"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](161, 49152, null, 0, _delete_domain_warning_component__WEBPACK_IMPORTED_MODULE_14__["DeleteDomainWarningComponent"], [], { domains: [0, "domains"], visible: [1, "visible"] }, { visibleChange: "visibleChange", onConfirmation: "onConfirmation" }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"]))], function (_ck, _v) { var _co = _v.component; var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 7, 0, _ck(_v, 8, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.createDomain.title")); var currVal_1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 7, 1, _ck(_v, 9, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.common.ok")); var currVal_2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 7, 2, _ck(_v, 10, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.common.cancel")); var currVal_3 = _co.alertMessages; var currVal_4 = _co.isApplyButtonBlocked; _ck(_v, 7, 0, currVal_0, currVal_1, currVal_2, currVal_3, currVal_4); var currVal_12 = _co.createFaultDomain; _ck(_v, 14, 0, currVal_12); var currVal_17 = "domain-name-input"; _ck(_v, 30, 0, currVal_17); var currVal_28 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵinlineInterpolate"](1, "", _co.DOMAIN_NAME, ""); _ck(_v, 37, 0, currVal_28); var currVal_29 = "domain-name-input"; _ck(_v, 39, 0, currVal_29); var currVal_30 = ""; _ck(_v, 42, 0, currVal_30); _ck(_v, 53, 0); var currVal_38 = "host-filter"; _ck(_v, 62, 0, currVal_38); var currVal_42 = "host-filter"; _ck(_v, 67, 0, currVal_42); var currVal_50 = _co.selectedHosts; _ck(_v, 102, 0, currVal_50); var currVal_53 = "label"; _ck(_v, 121, 0, currVal_53); var currVal_57 = "domainName"; _ck(_v, 133, 0, currVal_57); var currVal_59 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 142, 0, _ck(_v, 143, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 1), _co.allHosts, _co.showOnlyStandaloneHosts)); _ck(_v, 142, 0, currVal_59); var currVal_61 = (_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 150, 0, _ck(_v, 151, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 1), _co.allHosts, _co.showOnlyStandaloneHosts)).length == 1); _ck(_v, 150, 0, currVal_61); var currVal_62 = (_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 154, 0, _ck(_v, 155, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 1), _co.allHosts, _co.showOnlyStandaloneHosts)).length != 1); _ck(_v, 154, 0, currVal_62); var currVal_63 = _co.domainsForDelete; var currVal_64 = _co.deleteDomainWarningVisible; _ck(_v, 161, 0, currVal_63, currVal_64); }, function (_ck, _v) { var _co = _v.component; var currVal_5 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 16).ngClassUntouched; var currVal_6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 16).ngClassTouched; var currVal_7 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 16).ngClassPristine; var currVal_8 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 16).ngClassDirty; var currVal_9 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 16).ngClassValid; var currVal_10 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 16).ngClassInvalid; var currVal_11 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 16).ngClassPending; _ck(_v, 12, 0, currVal_5, currVal_6, currVal_7, currVal_8, currVal_9, currVal_10, currVal_11); var currVal_13 = true; var currVal_14 = ((_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 22).control == null) ? null : _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 22).control.disabled); var currVal_15 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 22).addGrid(); _ck(_v, 18, 0, currVal_13, currVal_14, currVal_15); var currVal_16 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 30).forAttr; _ck(_v, 29, 0, currVal_16); var currVal_18 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 31, 0, _ck(_v, 32, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.createDomain.nameInputLabel")); _ck(_v, 31, 0, currVal_18); var currVal_19 = true; var currVal_20 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 39).id; var currVal_21 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 40).ngClassUntouched; var currVal_22 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 40).ngClassTouched; var currVal_23 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 40).ngClassPristine; var currVal_24 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 40).ngClassDirty; var currVal_25 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 40).ngClassValid; var currVal_26 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 40).ngClassInvalid; var currVal_27 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 40).ngClassPending; _ck(_v, 34, 0, currVal_19, currVal_20, currVal_21, currVal_22, currVal_23, currVal_24, currVal_25, currVal_26, currVal_27); var currVal_31 = true; var currVal_32 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 45).id; _ck(_v, 44, 0, currVal_31, currVal_32); var currVal_33 = _co.invalidDomainNameMessage; _ck(_v, 46, 0, currVal_33); var currVal_34 = true; var currVal_35 = ((_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 53).control == null) ? null : _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 53).control.disabled); var currVal_36 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 53).addGrid(); _ck(_v, 49, 0, currVal_34, currVal_35, currVal_36); var currVal_37 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 62).forAttr; _ck(_v, 61, 0, currVal_37); var currVal_39 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 63, 0, _ck(_v, 64, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.createDomain.hostFilter.label")); _ck(_v, 63, 0, currVal_39); var currVal_40 = true; var currVal_41 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 67).id; _ck(_v, 66, 0, currVal_40, currVal_41); var currVal_43 = (_co.showOnlyStandaloneHosts == true); _ck(_v, 69, 0, currVal_43); var currVal_44 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 72, 0, _ck(_v, 73, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.createDomain.hostFilter.standaloneHosts")); _ck(_v, 72, 0, currVal_44); var currVal_45 = (_co.showOnlyStandaloneHosts == false); _ck(_v, 75, 0, currVal_45); var currVal_46 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 78, 0, _ck(_v, 79, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.createDomain.hostFilter.allHosts")); _ck(_v, 78, 0, currVal_46); var currVal_47 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 85, 0, _ck(_v, 86, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.createDomain.selectHostsHint")); _ck(_v, 85, 0, currVal_47); var currVal_48 = true; var currVal_49 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 102).detailService.isOpen; _ck(_v, 88, 0, currVal_48, currVal_49); var currVal_51 = true; var currVal_52 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 121).ariaSort; _ck(_v, 117, 0, currVal_51, currVal_52); var currVal_54 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 126, 0, _ck(_v, 127, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.createDomain.hostColumn")); _ck(_v, 126, 0, currVal_54); var currVal_55 = true; var currVal_56 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 133).ariaSort; _ck(_v, 129, 0, currVal_55, currVal_56); var currVal_58 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 138, 0, _ck(_v, 139, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.faultDomains.action.createDomain.domainColumn")); _ck(_v, 138, 0, currVal_58); var currVal_60 = true; _ck(_v, 145, 0, currVal_60); });
}
function View_CreateFaultDomainComponent_7(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 0, "div", [["aria-hidden", "true"], ["class", "modal-backdrop opaque-backdrop"]], null, null, null, null, null))], null, null); }
function View_CreateFaultDomainComponent_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵpid"](0, _pipe_LocalizationPipe__WEBPACK_IMPORTED_MODULE_15__["LocalizationPipe"], []), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵpid"](0, _create_fault_domain_host_filter_pipe__WEBPACK_IMPORTED_MODULE_16__["HostFilterPipe"], []), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, null, 1, null, View_CreateFaultDomainComponent_1)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](3, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]], { ngIf: [0, "ngIf"] }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, null, 1, null, View_CreateFaultDomainComponent_7)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](6, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]], { ngIf: [0, "ngIf"] }, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"]))], function (_ck, _v) { var _co = _v.component; var currVal_0 = _co.visible; _ck(_v, 3, 0, currVal_0); var currVal_1 = _co.visible; _ck(_v, 6, 0, currVal_1); }, null); }
function View_CreateFaultDomainComponent_Host_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "vsan-create-fault-domain", [], null, null, null, View_CreateFaultDomainComponent_0, RenderType_CreateFaultDomainComponent)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 49152, null, 0, _create_fault_domain_component__WEBPACK_IMPORTED_MODULE_17__["CreateFaultDomainComponent"], [_angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormBuilder"]], null, null)], null, null); }
var CreateFaultDomainComponentNgFactory = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("vsan-create-fault-domain", _create_fault_domain_component__WEBPACK_IMPORTED_MODULE_17__["CreateFaultDomainComponent"], View_CreateFaultDomainComponent_Host_0, { domainsAndHosts: "domainsAndHosts", visible: "visible" }, { visibleChange: "visibleChange", onConfirmation: "onConfirmation" }, []);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateFaultDomainComponent", function() { return CreateFaultDomainComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "8Y7J");
/* harmony import */ var _util_vsan_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @util/vsan-util */ "UODZ");
/* harmony import */ var _util_icon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @util/icon */ "cbfQ");
/* harmony import */ var _single_site_fault_domains_page_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./single-site-fault-domains-page.component */ "5asQ");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "s7LF");
/* harmony import */ var _util_reactive_form_util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @util/reactive-form-util */ "4Nty");
...
class CreateFaultDomainComponent {
    constructor(formBuilder) {
        ...
        this.initData = () => {
            if (this.domainsAndHosts) {
                this.domainsAndHosts.forEach((item) => {
        ...
        this.validateDomainName = (control) => {
        ...
        this.createDomain = () => {
            ...
            this.onConfirmation.emit(new _single_site_fault_domains_page_component__WEBPACK_IMPORTED_MODULE_3__["DomainTreeItem"](domainName, _util_icon__WEBPACK_IMPORTED_MODULE_2__["Icon"].FAULT_DOMAIN, false, this.selectedHosts));
        };
        this.close = () => {
            this.visible = false;
        };
        this.applyFilter = (onlyStandalone) => {
         ...
         */
        this.onCreateNewDomainConfirmation = (deleteEmptyDomains) => {
        ...
        this.createFaultDomain = this.formBuilder.group({
            [this.DOMAIN_NAME]: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]("", [this.validateDomainName])
        });
    }
    set visible(value) {
        this._visible = value;
    ...
    getDomainNameErrorMessage(name) {
        if (!name) {
    ...
    get domainsForDelete() {
        ...
        this.domainsAndHosts.forEach((item) => {
            if (item instanceof _single_site_fault_domains_page_component__WEBPACK_IMPORTED_MODULE_3__["DomainTreeItem"] && item.hosts) {
                ...
                const hostHasToBeDeleted = item.hosts.every((host) => {
