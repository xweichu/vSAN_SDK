(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[36], {
    ...
    "Erac":
    /*!******************************************************!*\
      !*** ./src/app/generated/hcl-update-offline-spec.ts ***!
      \******************************************************/

    /*! exports provided: HclUpdateOfflineSpec */

    /***/
    function Erac(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "HclUpdateOfflineSpec", function () {
        return HclUpdateOfflineSpec;
      });

      var HclUpdateOfflineSpec;

      (function (HclUpdateOfflineSpec) {
        var Factory = /*#__PURE__*/_createClass(function Factory() {
          _classCallCheck(this, Factory);
        }); //class Factory


        Factory.create = function (hclDatabaseFileZlibCompressedContent) {
          return {
            hclDatabaseFileZlibCompressedContent: hclDatabaseFileZlibCompressedContent
          };
        };

        HclUpdateOfflineSpec.Factory = Factory;
      })(HclUpdateOfflineSpec || (HclUpdateOfflineSpec = {})); //module HclUpdateOfflineSpec
    ...
    "G+D7":
    /*!*************************************************************!*\
      !*** ./src/app/vsan/update/action/update-actions.module.ts ***!
      \*************************************************************/

    /*! exports provided: UpdateActionsModule */

    /***/
    function GD7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "UpdateActionsModule", function () {
        return UpdateActionsModule;
      });

      var UpdateActionsModule = /*#__PURE__*/_createClass(function UpdateActionsModule() {
        _classCallCheck(this, UpdateActionsModule);
      });
      /***/
    ...
    "GbrE":
    /*!*******************************************************************************!*\
      !*** ./src/app/vsan/update/action/release-catalog-update-action.component.ts ***!
      \*******************************************************************************/

    /*! exports provided: VsanReleaseCatalogUpdateActionComponent */

    /***/
    function GbrE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "VsanReleaseCatalogUpdateActionComponent", function () {
        return VsanReleaseCatalogUpdateActionComponent;
      });
      /* harmony import */
      ...
      var VsanReleaseCatalogUpdateActionComponent = /*#__PURE__*/_createClass(function VsanReleaseCatalogUpdateActionComponent(updateDbService) {
        var _this = this;

        _classCallCheck(this, VsanReleaseCatalogUpdateActionComponent);

        this.updateDbService = updateDbService;
        this.hasEditPermissions = false;
        this.updateComplete = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.error = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.updating = false;

        this.uploadCalatog = function (bytes) {
          _this.updating = true;

          _this.updateDbService.uploadReleaseDb(_service_managed_object__WEBPACK_IMPORTED_MODULE_2__["ManagedObject"].contextObject, bytes).then(_this.handleActionSuccess)["catch"](_this.handleError);
        };

        this.onFileReadError = function (event) {
          _this.error.emit(_util_vsan_util__WEBPACK_IMPORTED_MODULE_1__["VsanUiUtils"].getString("vsan.vc.configure.releaseCatalog.error.fileUpload"));
        };

        this.handleActionSuccess = function () {
          _this.updating = false;

          _this.updateComplete.emit(true);
        };

        this.handleError = function (ex) {
          _this.updating = false;

          _this.error.emit(_util_vsan_util__WEBPACK_IMPORTED_MODULE_1__["VsanUiUtils"].getString("vsan.vc.configure.releaseCatalog.error.updateCatalog"));
        };
      });
      /***/
    ...
    "K5S9":
    /*!*****************************************************************************************!*\
      !*** ./src/app/vsan/update/action/release-catalog-update-action.component.ngfactory.js ***!
      \*****************************************************************************************/

    /*! exports provided: RenderType_VsanReleaseCatalogUpdateActionComponent, View_VsanReleaseCatalogUpdateActionComponent_0, View_VsanReleaseCatalogUpdateActionComponent_Host_0, VsanReleaseCatalogUpdateActionComponentNgFactory */

    /***/
    function K5S9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RenderType_VsanReleaseCatalogUpdateActionComponent", function () {
        return RenderType_VsanReleaseCatalogUpdateActionComponent;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "View_VsanReleaseCatalogUpdateActionComponent_0", function () {
        return View_VsanReleaseCatalogUpdateActionComponent_0;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "View_VsanReleaseCatalogUpdateActionComponent_Host_0", function () {
        return View_VsanReleaseCatalogUpdateActionComponent_Host_0;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "VsanReleaseCatalogUpdateActionComponentNgFactory", function () {
        return VsanReleaseCatalogUpdateActionComponentNgFactory;
      });
      /* harmony import */
      ...
      var _common_directive_upload_file_selector_directive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../common/directive/upload/file-selector.directive */
      "UcVh");
      /* harmony import */


      var _release_catalog_update_action_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./release-catalog-update-action.component */
      "GbrE");
      /* harmony import */


      var _generated_update_db_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var styles_VsanReleaseCatalogUpdateActionComponent = [_update_catalog_action_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__["styles"]];

      var RenderType_VsanReleaseCatalogUpdateActionComponent = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({
        encapsulation: 0,
        styles: styles_VsanReleaseCatalogUpdateActionComponent,
        data: {}
      });

      function View_VsanReleaseCatalogUpdateActionComponent_0(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵpid"](0, _common_pipe_LocalizationPipe__WEBPACK_IMPORTED_MODULE_2__["LocalizationPipe"], []), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 3, "button", [["id", "upload-catalog-button"], ["type", "button"]], [[8, "className", 0], [8, "disabled", 0]], [[null, "fileRead"], [null, "onFileReadError"], [null, "click"]], function (_v, en, $event) {
          var ad = true;
          var _co = _v.component;

          if ("click" === en) {
            var pd_0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 3).onBtnClick() !== false;
            ad = pd_0 && ad;
          }

          if ("fileRead" === en) {
            var pd_1 = _co.uploadCalatog($event) !== false;
            ad = pd_1 && ad;
          }

          if ("onFileReadError" === en) {
            var pd_2 = _co.onFileReadError($event) !== false;
            ad = pd_2 && ad;
          }

          return ad;
        }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](3, 212992, null, 0, _common_directive_upload_file_selector_directive__WEBPACK_IMPORTED_MODULE_3__["FileSelector"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], {
          elementId: [0, "elementId"]
        }, {
          fileRead: "fileRead",
          onFileReadError: "onFileReadError"
        }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](4, null, ["\n   ", "\n"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵppd"](5, 1)], function (_ck, _v) {
          var currVal_2 = "vsan-release-catalog-file-selector";

          _ck(_v, 3, 0, currVal_2);
        }, function (_ck, _v) {
          var _co = _v.component;
          var currVal_0 = _co.btnClasses;
          var currVal_1 = _co.updating || !_co.hasEditPermissions;

          _ck(_v, 2, 0, currVal_0, currVal_1);

          var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 4, 0, _ck(_v, 5, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 0), "vsan.vc.configure.releaseCatalog.button.update"));

          _ck(_v, 4, 0, currVal_3);
        });
      }

      function View_VsanReleaseCatalogUpdateActionComponent_Host_0(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "vsan-release-catalog-update-action", [], null, null, null, View_VsanReleaseCatalogUpdateActionComponent_0, RenderType_VsanReleaseCatalogUpdateActionComponent)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 49152, null, 0, _release_catalog_update_action_component__WEBPACK_IMPORTED_MODULE_4__["VsanReleaseCatalogUpdateActionComponent"], [_generated_update_db_service__WEBPACK_IMPORTED_MODULE_5__["UpdateDbService"]], null, null)], null, null);
      }

      var VsanReleaseCatalogUpdateActionComponentNgFactory = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("vsan-release-catalog-update-action", _release_catalog_update_action_component__WEBPACK_IMPORTED_MODULE_4__["VsanReleaseCatalogUpdateActionComponent"], View_VsanReleaseCatalogUpdateActionComponent_Host_0, {
    ...
    "UcVh":
    /*!*************************************************************************!*\
      !*** ./src/app/vsan/common/directive/upload/file-selector.directive.ts ***!
      \*************************************************************************/

    /*! exports provided: FileSelector */

    /***/
    function UcVh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var pako__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! pako */
      "16wW");
      /* harmony import */


      var pako__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(pako__WEBPACK_IMPORTED_MODULE_2__);
      ...
      var FileSelector = /*#__PURE__*/function () {
        function FileSelector(el) {
          var _this2 = this;

          _classCallCheck(this, FileSelector);

          this.fileRead = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
          this.onFileReadError = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();

          this.upload = function (fileEvent) {
            ...
            reader.onload = function (readerEvent) {
              ...
              try {
                var bytes = Array.from(pako__WEBPACK_IMPORTED_MODULE_2__["deflate"](data));

                _this2.fileRead.emit(bytes);
              } catch (err) {
                _util_logger__WEBPACK_IMPORTED_MODULE_1__["Logger"].error("Failed to compress file:", err);

                _this2.onFileReadError.emit();
              }

              _this2.fileSelector.value = null;
            };

            reader.onerror = function () {
              _util_logger__WEBPACK_IMPORTED_MODULE_1__["Logger"].error("Failed to load file:", file);
    ...
    "Yf4m":
    /*!*******************************************************************************!*\
      !*** ./src/app/vsan/update/action/update-catalog-action.scss.shim.ngstyle.js ***!
      \*******************************************************************************/

    /*! exports provided: styles */

    /***/
    function Yf4m(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "a9f/":
    /*!**************************************************************************************!*\
      !*** ./src/app/vsan/update/action/hcl-database-update-action.component.ngfactory.js ***!
      \**************************************************************************************/

    /*! exports provided: RenderType_HclDatabaseUpdateAction, View_HclDatabaseUpdateAction_0, View_HclDatabaseUpdateAction_Host_0, HclDatabaseUpdateActionNgFactory */

    /***/
    function a9f(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RenderType_HclDatabaseUpdateAction", function () {
        return RenderType_HclDatabaseUpdateAction;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "View_HclDatabaseUpdateAction_0", function () {
        return View_HclDatabaseUpdateAction_0;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "View_HclDatabaseUpdateAction_Host_0", function () {
        return View_HclDatabaseUpdateAction_Host_0;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "HclDatabaseUpdateActionNgFactory", function () {
        return HclDatabaseUpdateActionNgFactory;
      });
      /* harmony import */
      ...
      var _hcl_database_update_action_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./hcl-database-update-action.component */
      "yala");
      /* harmony import */
      ...
      var styles_HclDatabaseUpdateAction = [_update_catalog_action_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__["styles"]];

      var RenderType_HclDatabaseUpdateAction = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({
        encapsulation: 0,
        styles: styles_HclDatabaseUpdateAction,
        data: {}
      });

      function View_HclDatabaseUpdateAction_0(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵpid"](0, _common_pipe_LocalizationPipe__WEBPACK_IMPORTED_MODULE_2__["LocalizationPipe"], []), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 3, "button", [["id", "update-from-file-btn"]], [[8, "className", 0], [8, "disabled", 0]], [[null, "fileRead"], [null, "onFileReadError"], [null, "click"]], function (_v, en, $event) {
          var ad = true;
          var _co = _v.component;
          ...
          if ("fileRead" === en) {
            var pd_1 = _co.fileContentLoaded($event) !== false;
            ad = pd_1 && ad;
          }
          ...
          fileRead: "fileRead",
          onFileReadError: "onFileReadError"
        }), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](4, null, ["\n   ", "\n"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵppd"](5, 1), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](7, 0, null, null, 2, "button", [["id", "update-online-btn"]], [[8, "className", 0], [8, "disabled", 0]], [[null, "click"]], function (_v, en, $event) {
          var ad = true;
          var _co = _v.component;

          if ("click" === en) {
            var pd_0 = _co.updateOnline() !== false;
            ad = pd_0 && ad;
          }

          return ad;
        }, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](8, null, ["\n   ", "\n"])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵppd"](9, 1)], function (_ck, _v) {
          var currVal_2 = "hcl-db-file-selector";

          _ck(_v, 3, 0, currVal_2);
        }, function (_ck, _v) {
          var _co = _v.component;
          var currVal_0 = _co.btnClasses;
          var currVal_1 = _co.updating || _co.isDisabled;

          _ck(_v, 2, 0, currVal_0, currVal_1);

          var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 4, 0, _ck(_v, 5, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 0), "vsan.vc.configure.hclDatabase.button.updateOffline"));

          _ck(_v, 4, 0, currVal_3);

          var currVal_4 = _co.btnClasses;
          var currVal_5 = _co.updating || _co.isDisabled;

          _ck(_v, 7, 0, currVal_4, currVal_5);

          var currVal_6 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 8, 0, _ck(_v, 9, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v, 0), "vsan.vc.configure.hclDatabase.button.updateOnline"));

          _ck(_v, 8, 0, currVal_6);
        });
      }

      function View_HclDatabaseUpdateAction_Host_0(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "vsan-hcl-database-update-action", [], null, null, null, View_HclDatabaseUpdateAction_0, RenderType_HclDatabaseUpdateAction)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 49152, null, 0, _hcl_database_update_action_component__WEBPACK_IMPORTED_MODULE_4__["HclDatabaseUpdateAction"], [_generated_update_db_service__WEBPACK_IMPORTED_MODULE_5__["UpdateDbService"]], null, null)], null, null);
      }

      var HclDatabaseUpdateActionNgFactory = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("vsan-hcl-database-update-action", _hcl_database_update_action_component__WEBPACK_IMPORTED_MODULE_4__["HclDatabaseUpdateAction"], View_HclDatabaseUpdateAction_Host_0, {
        btnClasses: "btnClasses",
    ...
    "yala":
    /*!****************************************************************************!*\
      !*** ./src/app/vsan/update/action/hcl-database-update-action.component.ts ***!
      \****************************************************************************/

    /*! exports provided: HclDatabaseUpdateAction */

    /***/
    function yala(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "HclDatabaseUpdateAction", function () {
        return HclDatabaseUpdateAction;
      });
      /* harmony import */
      ...
      var _generated_hcl_update_offline_spec__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! @generated/hcl-update-offline-spec */
      "Erac");
      ...
      var HclDatabaseUpdateAction = /*#__PURE__*/_createClass(function HclDatabaseUpdateAction(updateDbService) {
        var _this3 = this;

        _classCallCheck(this, HclDatabaseUpdateAction);
        ...
        this.updateOnline = function () {
          ...
          _this3.updateDbService.updateHclDbFromWeb(_service_managed_object__WEBPACK_IMPORTED_MODULE_1__["ManagedObject"].contextObject).then(_this3.handleActionSuccess)["catch"](_this3.onUpdateOnlineError);
        };

        this.fileContentLoaded = function (bytes) {
          _this3.updating = true;

          _this3.updateDbService.uploadHclDb(_service_managed_object__WEBPACK_IMPORTED_MODULE_1__["ManagedObject"].contextObject, _generated_hcl_update_offline_spec__WEBPACK_IMPORTED_MODULE_3__["HclUpdateOfflineSpec"].Factory.create(bytes)).then(_this3.handleActionSuccess)["catch"](_this3.onUpdateOfflineError);
        };

        this.onFileReadError = function (event) {
          _this3.updating = false;

          _this3.error.emit(_util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.vc.configure.hclDatabase.error.fileUpload"));
        };

        this.handleActionSuccess = function () {
          _this3.updating = false;

          _this3.updateComplete.emit(true);
        };

        this.onUpdateOnlineError = function () {
          _this3.updating = false;

          _this3.error.emit(_util_vsan_util__WEBPACK_IMPORTED_MODULE_2__["VsanUiUtils"].getString("vsan.vc.configure.hclDatabase.error.onlineUpdate"));
        };

        this.onUpdateOfflineError = function (ex) {
          _this3.updating = false;

          _this3.error.emit(ex.toString());
        };
      });
      /***/
