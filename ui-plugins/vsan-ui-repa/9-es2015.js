...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReasonToBeUnavailable", function() { return ReasonToBeUnavailable; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RequiredServicesData", function() { return RequiredServicesData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RequiredService", function() { return RequiredService; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UnavailableViewSpec", function() { return UnavailableViewSpec; });
/* harmony import */ var _navigation_model_knowledge_base_id__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @navigation/model/knowledge-base-id */ "9lKY");
/* harmony import */ var _navigation_navigation_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @navigation/navigation.service */ "Qw2S");
...
class RequiredServicesData {
}
class RequiredService {
    constructor(name, isEnabled, unavailableViewSpec) {
        this.name = name;
        this.isEnabled = isEnabled;
        this.unavailableViewSpec = unavailableViewSpec;
    }
}
let UnavailableViewSpec = /*@__PURE__*/ (() => {
    class UnavailableViewSpec {
        constructor(reason, lightThemeImage, darkThemeImage, statusLabel) {
            this.reason = reason;
        ...
        static createInternalInstance(reason, lightThemeImage, darkThemeImage, statusLabel, featureDescription, kbArticleId, statusDescription, actionLabel, actionModuleId, actionDialogWidth, actionDialogHeight, requiredServicesData) {
            const spec = new UnavailableViewSpec(reason, lightThemeImage, darkThemeImage, statusLabel);
        ...
        static createExternalInstance(reason, lightThemeImage, darkThemeImage, statusLabel, actionLabel, externalExtensionId, featureDescription, kbArticleId, statusDescription) {
            const spec = new UnavailableViewSpec(reason, lightThemeImage, darkThemeImage, statusLabel);
            spec.actionLabel = actionLabel;
        ...
        static createRequiredService(reason, externalExtensionId, actionLabel) {
            const spec = new UnavailableViewSpec(reason, null, null, null);
            spec.actionLabel = actionLabel;
            spec.externalExtensionId = externalExtensionId;
            return spec;
        }
        get multipleServicesRequired() {
        ...
        get allRequiredServicesAreEnabled() {
            return this.multipleServicesRequired &&
                this.requiredServicesData.requiredServices.every(service => service.isEnabled);
        }
        /**
         * Disable the action button based on some reason determined at runtime.
         */
        disableActionButton(reason) {
            this.actionDisable = true;
            this.actionDisableReason = reason;
        }
        setRequiredServiceStatus(unavailableViewSpec, isEnabled) {
            if (this.multipleServicesRequired) {
                this.requiredServicesData.requiredServices.forEach(service => {
        ...
        static getPerformanceDiagnosticsViewRequiredServicesData() {
            const requiredServicesData = new RequiredServicesData();
            ...
            requiredServicesData.requiredServices = [
                new RequiredService(_util_vsan_util__WEBPACK_IMPORTED_MODULE_3__["VsanUiUtils"].getString("vsan.disabledService.performanceDiagnosticsView.perfServiceName"), false, UnavailableViewSpec.PERF_DISABLED),
                new RequiredService(_util_vsan_util__WEBPACK_IMPORTED_MODULE_3__["VsanUiUtils"].getString("vsan.disabledService.performanceDiagnosticsView.ceipName"), false, UnavailableViewSpec.PERF_DIAGNOSTICS_VIEW_CEIP_DISABLED),
            ];
