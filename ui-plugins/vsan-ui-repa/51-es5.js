(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[51], {
    ...
    /***/
    function JL8C(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Zq3e(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _pie_chart_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./pie-chart.scss.shim.ngstyle */
      "JL8C");
      /* harmony import */
      ...
      var _pie_chart_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./pie-chart.component */
      "pocS");
      /* harmony import */


      var _highcharts_properties_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../highcharts-properties.service */
      "Z7Pm");
      /* harmony import */


      var _highcharts_theme_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var RenderType_PieChartComponent = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({
        encapsulation: 0,
      ...
      function View_PieChartComponent_1(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 9, "div", [["class", "total-section"], ["tabindex", "0"]], null, [[null, "keyup.enter"], [null, "click"]], function (_v, en, $event) {
          ...
          var _co = _v.component;
          var currVal_0 = "total-section";

          var currVal_1 = _ck(_v, 2, 0, _co.hasTotalClickSubscribers);

          _ck(_v, 1, 0, currVal_0, currVal_1);
        }, function (_ck, _v) {
          var _co = _v.component;
          var currVal_2 = _co.totalLabel;

          _ck(_v, 5, 0, currVal_2);

          var currVal_3 = _co.sectionsTotal;
      ...
      var PieChartComponentNgFactory = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("vsan-pie-chart", _pie_chart_component__WEBPACK_IMPORTED_MODULE_4__["PieChartComponent"], View_PieChartComponent_Host_0, {
        sections: "sections",
        innerSize: "innerSize",
        chartSize: "chartSize",
        startAngle: "startAngle",
        showLabels: "showLabels",
        showTooltipLabels: "showTooltipLabels",
        showTotal: "showTotal",
    ...
    /***/
    function pocS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var PieChartComponent = /*#__PURE__*/function () {
        function PieChartComponent(highchartsService, highchartsThemeService, changeDetector, refWatcher) {
          var _this = this;
          ...
          this.applyHighchartOptions = function () {
            _this.highchartOptions = _this.highchartsService.getPieChartOptions(function (event) {
              return _this.onChartSelection(event);
            });
          };

          this.updateChartCustomSettings = function () {
            _this.highchartOptions.plotOptions.pie.innerSize = _this.innerSize;
            _this.highchartOptions.chart.height = _this.chartSize;
            _this.highchartOptions.plotOptions.pie.startAngle = _this.startAngle;
            _this.highchartOptions.plotOptions.pie.dataLabels.enabled = _this.showLabels;
            _this.highchartOptions.tooltip.enabled = _this.showTooltips;
          };

          this.updateSectionsData = function () {
            if (!_this.sections) {
              return;
            }
            ...
            _this.sections.filter(function (section) {
              return section.showValue;
              ...
              if (_this.showTooltipLabels) {
                /**
                 * Tooltip will be displayed in format "label: value"
                 */
                section.custom.tooltipValue = new Map([[section.name, _util_vsan_util__WEBPACK_IMPORTED_MODULE_1__["VsanUiUtils"].formatFileSize(section.y)]]);
              }
            ...
            if (_this.showTotal) {
              ...
              _this.sectionsTotal = _util_vsan_util__WEBPACK_IMPORTED_MODULE_1__["VsanUiUtils"].formatFileSize(total);
            }

            _this.highchartOptions.series = series; // Avoid "expression changed after it was checked error"
        ...
        _createClass(PieChartComponent, [{
          ...
          key: "configureChartOptions",
          value: function configureChartOptions() {
          ...
          key: "onChartSelection",
          value: function onChartSelection(event) {
            if (event.point) {
          ...
          key: "onTotalClick",
          value: function onTotalClick(event) {
