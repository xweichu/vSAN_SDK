...
/* harmony import */ var _util_platform__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @util/platform */ "RrEr");
/* harmony import */ var _util_vsan_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @util/vsan-util */ "UODZ");
/* harmony import */ var _validation_alert_type__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../validation/alert-type */ "4KIt");
...
class PromptComponent {
    constructor(el, focusTrap) {
        ...
        this.onAdditionalAction = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    ...
    set alertMessages(alertMessages) {
        var _a;
    ...
    confirm() {
        const result = {}; // defined to trigger the modal callback
