(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[59], {
    ...
    /***/
    function RncG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _upgrade_data__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./upgrade.data */
      "+Sd+");
      ...
      var UpgradeComponent = /*@__PURE__*/function () {
        var UpgradeComponent = /*#__PURE__*/function () {
          function UpgradeComponent(dataService, upgradeService, taskService) {
            var _this = this;
            ...
            this.handleUpgradeVsanTask = function () {
              // Show upgrade current progress in progress bar
              setTimeout(_this.refreshUpgradeProgressBar, UpgradeComponent.PROGRESS_BAR_REFRESH_INTERVAL_MS);
            };

            this.handleUpgradeStatus = function () {
              var reloadPageUponUpgradeCompletion = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

              if (_this.upgradeData.isUpgradeInProgress) {
                ...
                _this.upgradeComplete.emit();
              }
            };

            this.refreshUpgradeProgressBar = function () {
              _this.upgradeService.getUpgradeStatus(_service_managed_object__WEBPACK_IMPORTED_MODULE_3__["ManagedObject"].contextObject).then(function (upgradeStatus) {
                if (_this.upgradeData) {
                  _this.upgradeData.upgradeStatus = upgradeStatus;
                  _this.upgradeData.isUpgradeInProgress = upgradeStatus.inProgress;
                }

                _this.handleUpgradeStatus(true);
              })["catch"](function (error) {
                _util_logger__WEBPACK_IMPORTED_MODULE_5__["Logger"].error(error);
              });
            };

            this.onPrecheckUpgrade = function (task) {
                ...
                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        _context.next = 2;
                        return this.taskService.getAwaitResult(task);

                      case 2:
                        _context.next = 4;
                        return this.precheckComplete.emit();
            ...
            this.openIssuesDetails = function () {
              if (!_this.upgradeData.upgradeStatus || !_this.upgradeData.upgradeStatus.issues) {
                return;
              }

              var PRE_CHECK_ISSUES_DIALOG_HEIGHT = UpgradeComponent.PRE_CHECK_ISSUES_DIALOG_INITIAL_HEIGHT + UpgradeComponent.PRE_CHECK_ISSUES_DIALOG_ALERT_ITEM_HEIGHT * _this.upgradeData.upgradeStatus.issues.length;
              var context = {
                clusterName: _this.clusterName,
                issues: _this.upgradeData.upgradeStatus.issues
              };
              new _util_modal_builder__WEBPACK_IMPORTED_MODULE_6__["ModalBuilder"]("diskManagement/preCheckIssues").setSize(600, PRE_CHECK_ISSUES_DIALOG_HEIGHT).open(context);
            };
          }
          ...
          _createClass(UpgradeComponent, [{
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        _context2.next = 2;
                        return this.dataService.getProperty(_service_client_dataservice_data_service_property__WEBPACK_IMPORTED_MODULE_2__["ClusterComputeResource"].name, _service_managed_object__WEBPACK_IMPORTED_MODULE_3__["ManagedObject"].contextObject);
            ...
            key: "onUpgradeDataSet",
            value: function onUpgradeDataSet() {
              this.resetData();
            ...
            value: function updateViewState() {
              this.precheckActionRelevant = this.upgradeData.upgradeDiskData.hasDisks && this.upgradeData.isAsyncPrecheckSupported && !this.upgradeData.isUpgraded;
              this.upgradeActionRelevant = this.upgradeData.upgradeDiskData.hasDisks && (!this.upgradeData.isUpgraded || this.upgradeData.hasOldVsanObject);
            ...
            key: "getFormatVersionIcon",
            value: function getFormatVersionIcon() {
            ...
            key: "getPrecheckUpgradeStatusIcon",
            value: function getPrecheckUpgradeStatusIcon() {
              if (!this.upgradeData.hasPrecheckRunInformation || this.upgradeData.status !== _upgrade_data__WEBPACK_IMPORTED_MODULE_7__["VsanUpgradeStatus"].COMPLETED || this.upgradeData.hasPrecheckIssues) {
                return _util_icon__WEBPACK_IMPORTED_MODULE_4__["Icon"].CLR_WARN_STANDARD_ICON_SHAPE;
              }
            ...
            key: "getIconShapeClass",
            value: function getIconShapeClass(shape) {
            ...
            key: "upgradeVsan",
            value: function upgradeVsan() {
              var context = {
                clusterName: this.clusterName,
                upgradeData: this.upgradeData
              };
              new _util_modal_builder__WEBPACK_IMPORTED_MODULE_6__["ModalBuilder"]("upgrade/upgrade").setSize(700, 350).open(context).then(this.handleUpgradeVsanTask)["catch"](function (error) {
                _util_logger__WEBPACK_IMPORTED_MODULE_5__["Logger"].error(error);
              });
            }
            /*
            ...
            key: "precheckUpgrade",
            value: function precheckUpgrade() {
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        _context3.next = 5;
                        return this.upgradeService.precheckUpgrade(_service_managed_object__WEBPACK_IMPORTED_MODULE_3__["ManagedObject"].contextObject);

                      case 5:
                        task = _context3.sent;
                        _context3.next = 8;
                        return this.onPrecheckUpgrade(task);
    ...
    /***/
    function hH9Q(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RenderType_UpgradeComponent", function () {
        return RenderType_UpgradeComponent;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "View_UpgradeComponent_0", function () {
        return View_UpgradeComponent_0;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "View_UpgradeComponent_Host_0", function () {
        return View_UpgradeComponent_Host_0;
      });
      /* harmony export (binding) */


      __webpack_require__.d(__webpack_exports__, "UpgradeComponentNgFactory", function () {
        return UpgradeComponentNgFactory;
      });
      /* harmony import */


      var _upgrade_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./upgrade.scss.shim.ngstyle */
      "2QZd");
      /* harmony import */
      ...
      var _upgrade_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./upgrade.component */
      "RncG");
      /* harmony import */


      var _service_client_dataservice_data_service_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../../service/client/dataservice/data-service.service */
      "QIo8");
      /* harmony import */


      var _upgrade_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./upgrade.service */
      "Ndfo");
      /* harmony import */
      ...
      var RenderType_UpgradeComponent = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({
        encapsulation: 0,
        styles: styles_UpgradeComponent,
        data: {}
      });

      function View_UpgradeComponent_1(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 3, "div", [["class", "busy-backdrop"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 0, "span", [["class", "spinner spinner-md central-spinner"], ["id", "busy-spinner"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"]))], null, null);
      }
      ...
      function View_UpgradeComponent_3(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 7, "div", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 0, "span", [["class", "spinner spinner-sm spinner-inline"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](4, 0, null, null, 2, "span", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](5, null, ["", ""])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵppd"](6, 1), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"]))], null, function (_ck, _v) {
          var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 5, 0, _ck(_v, 6, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent, 0), "vsan.manage.diskManagement.upgradeComponent.loading"));

          _ck(_v, 5, 0, currVal_0);
        });
      }

      function View_UpgradeComponent_6(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 3, "clr-icon", [["aria-hidden", "true"]], [[1, "shape", 0], [8, "className", 0]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 16384, null, 0, _clr_angular__WEBPACK_IMPORTED_MODULE_4__["ClrIconCustomTag"], [], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](2, 4210688, null, 0, _directive_icon_title_icon_title_directive__WEBPACK_IMPORTED_MODULE_5__["IconTitleDirective"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "]))], null, function (_ck, _v) {
          var _co = _v.component;
          var currVal_0 = _co.diskFormatVersionIcon;

          var currVal_1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵinlineInterpolate"](1, "", _co.getIconShapeClass(_co.diskFormatVersionIcon), "");
      ...
      function View_UpgradeComponent_7(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 2, "button", [["class", "btn btn-sm btn-outline"], ["id", "upgradeButton"], ["type", "button"]], [[8, "disabled", 0]], [[null, "click"]], function (_v, en, $event) {
          ...
          var _co = _v.component;
          var currVal_0 = !_co.hasUpgradePermission;

          _ck(_v, 0, 0, currVal_0);

          var currVal_1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 1, 0, _ck(_v, 2, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent.parent.parent, 0), "vsan.upgrade.manage.action.upgrade"));
      ...
      function View_UpgradeComponent_8(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 2, "button", [["class", "btn btn-sm btn-outline"], ["id", "precheckButton"], ["type", "button"]], [[8, "disabled", 0]], [[null, "click"]], function (_v, en, $event) {
          ...
          var currVal_1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 1, 0, _ck(_v, 2, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent.parent.parent, 0), "vsan.upgrade.manage.action.precheckUpgrade"));
      ...
      function View_UpgradeComponent_5(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 23, null, null, null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 16, "div", [["class", "icon-name-container"], ["id", "vsanDiskFormatVersionRow"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, null, 1, null, View_UpgradeComponent_6)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](5, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]], {
          ...
          var _co = _v.component;
          var currVal_0 = _co.upgradeData.upgradeDiskData.hasDisks;

          _ck(_v, 5, 0, currVal_0);

          var currVal_2 = _co.upgradeActionRelevant;

          _ck(_v, 13, 0, currVal_2);

          var currVal_3 = _co.precheckActionRelevant;

          _ck(_v, 16, 0, currVal_3);

          var currVal_4 = !_co.upgradeData.isUpgraded;

          _ck(_v, 22, 0, currVal_4);
        }, function (_ck, _v) {
          var _co = _v.component;

          var currVal_1 = _co.upgradeData.getOverallUpgradeStatus(_co.showCompatibilityWarning);

          _ck(_v, 8, 0, currVal_1);
        });
      }

      function View_UpgradeComponent_12(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 11, "div", [["class", "icon-name-container"], ["id", "upgrade-inprogress-warning"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 4, "clr-icon", [["aria-hidden", "true"], ["class", "is-solid"]], [[1, "shape", 0]], null, null, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](3, 278528, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgClass"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["IterableDiffers"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["KeyValueDiffers"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"]], {
          klass: [0, "klass"],
          ngClass: [1, "ngClass"]
          ...
          var currVal_2 = _co.Icon.CLR_WARN_ICON_CLASS;
          ...
          var currVal_3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 9, 0, _ck(_v, 10, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent.parent.parent, 0), "vsan.manage.upgrade.inprogress.compatibility.warning"));

          _ck(_v, 9, 0, currVal_3);
        });
      }

      function View_UpgradeComponent_13(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 2, "div", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](1, null, ["\n         ", "\n      "])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵppd"](2, 2)], null, function (_ck, _v) {
          ...
          var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 1, 0, _ck(_v, 2, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent.parent.parent, 0), "vsan.upgrade.manage.progress.currentTaskFormat", _co.upgradeData.upgradeStatus.currentOperationName));

          _ck(_v, 1, 0, currVal_0);
        });
      }

      function View_UpgradeComponent_14(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 7, "div", [["class", "progress labeled"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 0, "progress", [["max", "100"], ["value", "0"]], [[8, "value", 0]], null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n         "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](4, 0, null, null, 2, "span", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](5, null, ["", ""])), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵppd"](6, 2), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "]))], null, function (_ck, _v) {
          var _co = _v.component;

          var currVal_0 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵinlineInterpolate"](1, "", _co.upgradeData.upgradeStatus.progress, "");

          _ck(_v, 2, 0, currVal_0);

          var currVal_1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 5, 0, _ck(_v, 6, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent.parent.parent, 0), "vsan.common.percentage", _co.upgradeData.upgradeStatus.progress));

          _ck(_v, 5, 0, currVal_1);
        });
      }

      function View_UpgradeComponent_11(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 14, "div", [["id", "vsanUpgradeRow"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n      "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, null, 1, null, View_UpgradeComponent_12)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](3, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]], {
          ngIf: [0, "ngIf"]
          ...
          var _co = _v.component;
          var currVal_0 = _co.showCompatibilityWarning;

          _ck(_v, 3, 0, currVal_0);

          var currVal_2 = _co.upgradeData.upgradeStatus.currentOperationName;

          _ck(_v, 10, 0, currVal_2);

          var currVal_3 = _co.upgradeData.upgradeStatus.progress;

          _ck(_v, 13, 0, currVal_3);
        }, function (_ck, _v) {
          var _co = _v.component;

          var currVal_1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵunv"](_v, 6, 0, _ck(_v, 7, 0, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵnov"](_v.parent.parent, 0), "vsan.manage.upgrade.inProgress", _co.upgradeData.latestVersionAsString));

          _ck(_v, 6, 0, currVal_1);
        });
      }

      function View_UpgradeComponent_4(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 8, null, null, null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n   "])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, null, 1, null, View_UpgradeComponent_5)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](3, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]], {
          ...
          var _co = _v.component;
          var currVal_0 = !_co.upgradeData.isUpgradeInProgress;

          _ck(_v, 3, 0, currVal_0);

          var currVal_1 = _co.upgradeData.isUpgradeInProgress;
      ...
      function View_UpgradeComponent_0(_l) {
        return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵpid"](0, _pipe_LocalizationPipe__WEBPACK_IMPORTED_MODULE_7__["LocalizationPipe"], []), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["\n"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵand"](16777216, null, null, 1, null, View_UpgradeComponent_1)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](3, 16384, null, 0, _angular_common__WEBPACK_IMPORTED_MODULE_6__["NgIf"], [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"]], {
          ...
          var _co = _v.component;
          var currVal_0 = _co.blockContent;
          ...
          var currVal_2 = !_co.upgradeData;

          _ck(_v, 9, 0, currVal_2);

          var currVal_3 = _co.upgradeData;
      ...
      var UpgradeComponentNgFactory = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("vsan-upgrade", _upgrade_component__WEBPACK_IMPORTED_MODULE_8__["UpgradeComponent"], View_UpgradeComponent_Host_0, {
        hasUpgradePermission: "hasUpgradePermission",
        showCompatibilityWarning: "showCompatibilityWarning",
        visibleWhenUpToDate: "visibleWhenUpToDate",
